  ...
  const onSubmit: SubmitHandler<CheckoutFormValues> = async (data) => {
    ...
    if (!isLocalStorageAvailable()) {
        toast({
            ...
            description: <TranslatedText fr="Le stockage local n'est pas disponible." en="Local storage is not available.">Der lokale Speicher ist nicht verfügbar.</TranslatedText>
        });
        return;
    }
    ...
    const success = safeSetLocalStorage('localOrders', JSON.stringify(localOrders));
