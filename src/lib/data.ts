...
export const categories: Category[] = [
  { 
    ...
    subcategories: [
      ...
      { id: 'sub-homme-4', name: 'Pulls', name_fr: 'Pulls', name_en: 'Sweaters', slug: 'pulls-homme' },
      { id: 'sub-homme-5', name: 'Accessoires', name_fr: 'Accessoires', name_en: 'Accessories', slug: 'accessoires-homme' },
      { id: 'sub-homme-6', name: 'Chaussures', name_fr: 'Chaussures', name_en: 'Shoes', slug: 'chaussures-homme' },
    ]
  },
  { 
    id: 'cat-2', 
    ...
    subcategories: [
      ...
      { id: 'sub-femme-5', name: 'Vestes', name_fr: 'Vestes', name_en: 'Jackets', slug: 'vestes-femme' },
      { id: 'sub-femme-6', name: 'Accessoires', name_fr: 'Accessoires', name_en: 'Accessories', slug: 'accessoires-femme' },
    ]
  },
...
export const products: Product[] = [
  ...
  {
    id: 'manteau-laine-premium-cat-1',
    name: 'Langer Mantel aus Premium-Wolle',
    name_fr: 'Manteau long en laine premium',
    name_en: 'Premium wool long coat',
    slug: 'manteau-laine-premium-winter-clothing',
    price: 200,
    description: 'Ein langer und eleganter Mantel aus hochwertiger Wolle.',
    description_fr: 'Un manteau long et élégant en laine de qualité supérieure.',
    description_en: 'A long and elegant coat made of premium quality wool.',
  ...
  {
    id: 'manteau-laine-premium-cat-1-cat-2',
    name: 'Langer Mantel aus Premium-Wolle',
    name_fr: 'Manteau long en laine premium',
    name_en: 'Premium wool long coat',
    slug: 'manteau-laine-premium-winter-clothing-mens-clothing',
    price: 200,
    description: 'Ein langer und eleganter Mantel aus hochwertiger Wolle.',
    description_fr: 'Un manteau long et élégant en laine de qualité supérieure.',
    description_en: 'A long and elegant coat made of premium quality wool.',
  ...
  {
    id: 'pull-cachemire-femme-cat-1',
    name: 'Cremefarbener 100% Kaschmirpullover',
    name_fr: 'Pull 100% cachemire crème',
    name_en: '100% Cream Cashmere Sweater',
    slug: 'pull-cachemire-femme-womens-clothing',
    price: 200,
    description: 'Umhüllende Weichheit mit diesem cremefarbenen Pullover aus reinem Kaschmir. Ein luxuriöses Basic für ultimativen Komfort und raffinierten Stil.',
    description_fr: 'La douceur enveloppante avec ce pull en pur cachemire de couleur crème. Un basique de luxe pour un confort ultime et un style raffiné.',
    description_en: 'Enveloping softness with this pure cream-colored cashmere sweater. A luxury basic for ultimate comfort and refined style.',
  ...
  {
    id: 'pull-cachemire-femme-cat-2',
    name: 'Cremefarbener 100% Kaschmirpullover',
    name_fr: 'Pull 100% cachemire crème',
    name_en: '100% Cream Cashmere Sweater',
    slug: 'pull-cachemire-femme-winter-clothing',
    price: 200,
    description: 'Umhüllende Weichheit mit diesem cremefarbenen Pullover aus reinem Kaschmir. Ein luxuriöses Basic für ultimativen Komfort und raffinierten Stil.',
    description_fr: 'La douceur enveloppante avec ce pull en pur cachemire de couleur crème. Un basique de luxe pour un confort ultime et un style raffiné.',
    description_en: 'Enveloping softness with this pure cream-colored cashmere sweater. A luxury basic for ultimate comfort and refined style.',
  ...
  },
  {
    ...
    name_fr: 'Robe midi en soie Gucci',
    name_en: 'Gucci Silk Midi Dress',
    slug: 'robe-midi-en-soie-gucci-sport',
    price: 490,
    description: 'Umhüllen Sie sich mit fließender Eleganz. Dieses Midikleid aus reiner Seide besticht durch seinen sanften Glanz und eine schmeichelhafte Silhouette, die bei jeder Bewegung tanzt. Ein Meisterwerk der Couture für unvergessliche Momente.',
    description_fr: 'Enveloppez-vous d\'une élégance fluide. Cette robe midi en pure soie se distingue par son éclat délicat et une silhouette flatteuse qui danse à chaque mouvement. Une pièce maîtresse de la couture pour des moments inoubliables.',
    description_en: 'Wrap yourself in fluid elegance. This pure silk midi dress features a delicate sheen and a flattering silhouette that dances with every move. A couture masterpiece for unforgettable moments.',
  ...
  },
  {
    ...
    name_fr: 'Robe midi en soie Gucci',
    name_en: 'Gucci Silk Midi Dress',
    slug: 'robe-midi-en-soie-gucci-sport-womens-clothing',
    price: 490,
    description: 'Umhüllen Sie sich mit fließender Eleganz. Dieses Midikleid aus reiner Seide besticht durch seinen sanften Glanz und eine schmeichelhafte Silhouette, die bei jeder Bewegung tanzt. Ein Meisterwerk der Couture für unvergessliche Momente.',
    description_fr: 'Enveloppez-vous d\'une élégance fluide. Cette robe midi en pure soie se distingue par son éclat délicat et une silhouette flatteuse qui danse à chaque mouvement. Une pièce maîtresse de la couture pour des moments inoubliables.',
    description_en: 'Wrap yourself in fluid elegance. This pure silk midi dress features a delicate sheen and a flattering silhouette that dances with every move. A couture masterpiece for unforgettable moments.',
  ...
  },
  {
    ...
    name_fr: 'Robe pull en cachemire',
    name_en: 'Cashmere Sweater Dress',
    slug: 'robe-pull-en-cachemire-max-mara-womens-clothing',
    price: 550,
    oldPrice: 680,
    description: 'Eine luxuriöse Pulloverkleid aus reinem Kaschmir, für eine komfortable und warme Eleganz. Seine lockere Passform und die Weichheit des Materials machen es zu einem Kokon des Luxus für den Winter.',
    description_fr: 'Une robe pull luxueuse en pur cachemire, pour une élégance confortable et chaleureuse. Sa coupe décontractée et la douceur de sa maille en font un cocon de luxe pour l\'hiver.',
  ...
  },
  {
    ...
    name_fr: 'Robe pull en cachemire',
    name_en: 'Cashmere Sweater Dress',
    slug: 'robe-pull-en-cachemire-max-mara-winter-clothing',
    price: 550,
    oldPrice: 680,
    description: 'Eine luxuriöse Pulloverkleid aus reinem Kaschmir, für eine komfortable und warme Eleganz. Seine lockere Passform und die Weichheit des Materials machen es zu einem Kokon des Luxus für den Winter.',
    description_fr: 'Une robe pull luxueuse en pur cachemire, pour une élégance confortable et chaleureuse. Sa coupe décontractée et la douceur de sa maille en font un cocon de luxe pour l\'hiver.',
  ...
  },
  {
    ...
    name_fr: 'Pull col bateau à manches ballon',
    name_en: 'Balloon-Sleeve Boatneck Sweater',
    slug: 'pull-col-bateau-manches-ballon-chloe-winter-clothing',
    price: 390,
    oldPrice: 490,
    description: 'Eine romantische und moderne Silhouette. Dieser Pullover mit U-Boot-Ausschnitt zeichnet sich durch seine voluminösen Ballonärmel aus und verleiht jedem Outfit einen Hauch von Couture.',
    description_fr: 'Une silhouette romantique et moderne. Ce pull à col bateau se distingue par ses manches ballon volumineuses, apportant une touche couture à n\'importe quelle tenue.',
  ...
  {
    id: 'prod-25-cat-1-cat-2',
    name: 'U-Boot-Ausschnitt-Pullover mit Ballonärmeln',
    name_fr: 'Pull col bateau à manches ballon',
    name_en: 'Balloon-Sleeve Boatneck Sweater',
    slug: 'pull-col-bateau-manches-ballon-chloe-winter-clothing-mens-clothing',
    price: 390,
    oldPrice: 490,
    description: 'Eine romantische und moderne Silhouette. Dieser Pullover mit U-Boot-Ausschnitt zeichnet sich durch seine voluminösen Ballonärmel aus und verleiht jedem Outfit einen Hauch von Couture.',
    description_fr: 'Une silhouette romantique et moderne. Ce pull à col bateau se distingue par ses manches ballon volumineuses, apportant une touche couture à n\'importe quelle tenue.',
  ...
  },
  {
    ...
    name_fr: 'Robe-chemise oversize',
    name_en: 'Oversize Shirtdress',
    slug: 'robe-chemise-oversize-balenciaga-womens-clothing',
    price: 800,
    description: 'Der Inbegriff von lässigem Chic. Diese Oversize-Hemdbluse in makellosem Weiß kann als Kleid oder offen über einer Hose getragen werden und bietet einen avantgardistischen und vielseitigen Stil.',
    description_fr: 'Le summum du chic décontracté. Cette robe-chemise oversize d\'un blanc immaculé peut être portée seule ou ouverte sur un pantalon, offrant un style avant-gardiste et polyvalent.',
    description_en: 'The height of casual chic. This immaculate white oversized shirtdress can be worn alone or open over trousers, offering an avant-garde and versatile style.',
  ...
  {
    id: 'prod-26-cat-1-cat-2',
    name: 'Oversize-Hemdblusenkleid',
    name_fr: 'Robe-chemise oversize',
    name_en: 'Oversize Shirtdress',
    slug: 'robe-chemise-oversize-balenciaga-womens-clothing-mens-clothing',
    price: 800,
    description: 'Der Inbegriff von lässigem Chic. Diese Oversize-Hemdbluse in makellosem Weiß kann als Kleid oder offen über einer Hose getragen werden und bietet einen avantgardistischen und vielseitigen Stil.',
    description_fr: 'Le summum du chic décontracté. Cette robe-chemise oversize d\'un blanc immaculé peut être portée seule ou ouverte sur un pantalon, offrant un style avant-gardiste et polyvalent.',
    description_en: 'The height of casual chic. This immaculate white oversized shirtdress can be worn alone or open over trousers, offering an avant-garde and versatile style.',
  ...
  },
  {
    ...
    name_fr: 'Pantalon palazzo en laine GUCCI',
    name_en: 'Wool Palazzo Pants GUCCI',
    slug: 'pantalon-palazzo-en-laine-max-mara-winter-clothing',
    price: 460,
    description: 'Eine majestätische Silhouette. Diese Palazzo-Hose aus fließender Wolle verlängert das Bein und bietet eine anmutige und kraftvolle Bewegung. Perfekt für einen anspruchsvollen Büro-Look oder einen eleganten Abend.',
    description_fr: 'Une allure majestueuse. Ce pantalon palazzo en laine fluide allonge la jambe et offre un mouvement gracieux et puissant. Parfait pour un look de bureau sophistiqué ou une soirée élégante.',
    description_en: 'A majestic allure. These fluid wool palazzo pants lengthen the leg and offer graceful and powerful movement. Perfect for a sophisticated office look or an elegant evening out.',
  ...
  },
  {
    ...
    name_fr: 'Pantalon palazzo en laine GUCCI',
    name_en: 'Wool Palazzo Pants GUCCI',
    slug: 'pantalon-palazzo-en-laine-max-mara-sport',
    price: 460,
    description: 'Eine majestätische Silhouette. Diese Palazzo-Hose aus fließender Wolle verlängert das Bein und bietet eine anmutige und kraftvolle Bewegung. Perfekt für einen anspruchsvollen Büro-Look oder einen eleganten Abend.',
    description_fr: 'Une allure majestueuse. Ce pantalon palazzo en laine fluide allonge la jambe et offre un mouvement gracieux et puissant. Parfait pour un look de bureau sophistiqué ou une soirée élégante.',
    description_en: 'A majestic allure. These fluid wool palazzo pants lengthen the leg and offer graceful and powerful movement. Perfect for a sophisticated office look or an elegant evening out.',
  ...
  },
  {
    ...
    name_fr: 'Pull col roulé cachemire loro-piana',
    name_en: 'Cashmere Turtleneck Sweater loro-piana',
    slug: 'pull-col-roule-cachemire-loro-piana-winter-clothing',
    price: 450,
    oldPrice: 550,
    description: 'Erleben Sie die Umarmung von purem Luxus. Dieser Rollkragenpullover aus feinstem mongolischem Kaschmir bietet unübertroffene Weichheit und wohlige Wärme. Ein Kunstwerk der Strickerei für die kältesten Tage.',
    description_fr: 'Vivez l\'étreinte du luxe pur. Ce pull à col roulé, confectionné dans le plus fin cachemire de Mongolie, offre une douceur inégalée et une chaleur réconfortante. Une œuvre d\'art du tricotage pour les jours les plus froids.',
  ...
  {
    id: 'prod-32-cat-1-cat-2',
    name: 'Kaschmir-Rollkragenpullover loro-piana',
    name_fr: 'Pull col roulé cachemire loro-piana',
    name_en: 'Cashmere Turtleneck Sweater loro-piana',
    slug: 'pull-col-roule-cachemire-loro-piana-winter-clothing-mens-clothing',
    price: 450,
    oldPrice: 550,
    description: 'Erleben Sie die Umarmung von purem Luxus. Dieser Rollkragenpullover aus feinstem mongolischem Kaschmir bietet unübertroffene Weichheit und wohlige Wärme. Ein Kunstwerk der Strickerei für die kältesten Tage.',
    description_fr: 'Vivez l\'étreinte du luxe pur. Ce pull à col roulé, confectionné dans le plus fin cachemire de Mongolie, offre une douceur inégalée et une chaleur réconfortante. Une œuvre d\'art du tricotage pour les jours les plus froids.',
  ...
  },
  {
    ...
    name_fr: 'Chemise en soie versace',
    name_en: 'versace Silk Shirt',
    slug: 'chemise-soie-versace-accessories',
    price: 450,
    description: 'Machen Sie Eindruck mit diesem kühnen Seidenhemd. Der ikonische Barockdruck und die fließende Seide sind ein Markenzeichen des Hauses Versace und garantieren einen unvergesslichen Stil, der Selbstbewusstsein ausstrahlt.',
    description_fr: 'Affirmez votre présence avec cette chemise en soie audacieuse. Son imprimé baroque iconique et la fluidité de la soie, signature de la maison Versace, garantissent un style mémorable qui respire la confiance.',
    description_en: 'Make a statement with this bold silk shirt. Its iconic baroque print and the fluidity of the silk, a signature of the house of Versace, guarantee a memorable style that exudes confidence.',
  ...
  {
    id: 'prod-40-cat-1-cat-2',
    name: 'versace Seidenhemd',
    name_fr: 'Chemise en soie versace',
    name_en: 'versace Silk Shirt',
    slug: 'chemise-soie-versace-accessories-mens-clothing',
    price: 450,
    description: 'Machen Sie Eindruck mit diesem kühnen Seidenhemd. Der ikonische Barockdruck und die fließende Seide sind ein Markenzeichen des Hauses Versace und garantieren einen unvergesslichen Stil, der Selbstbewusstsein ausstrahlt.',
    description_fr: 'Affirmez votre présence avec cette chemise en soie audacieuse. Son imprimé baroque iconique et la fluidité de la soie, signature de la maison Versace, garantissent un style mémorable qui respire la confiance.',
    description_en: 'Make a statement with this bold silk shirt. Its iconic baroque print and the fluidity of the silk, a signature of the house of Versace, guarantee a memorable style that exudes confidence.',
  ...
  {
    id: 'manteau-long-laine-hugo-boss-cat-1',
    name: 'Langer Wollmantel Hugo Boss',
    name_fr: 'Manteau Long en Laine Hugo Boss',
    name_en: 'Hugo Boss Long Wool Coat',
    slug: 'manteau-long-laine-hugo-boss-winter-clothing',
    price: 750,
    description: 'Ein ikonischer langer Mantel aus einer luxuriösen Wollmischung, perfekt für einen eleganten Winterlook. Sein minimalistischer Schnitt und die tadellosen Oberflächen machen ihn zu einem zeitlosen Must-have.',
    description_fr: 'Un manteau long iconique dans un mélange de laine luxueux, parfait pour une allure hivernale élégante. Sa coupe minimaliste et ses finitions impeccables en font un indispensable intemporel.',
    description_en: 'An iconic long coat in a luxurious wool blend, perfect for an elegant winter look. Its minimalist cut and impeccable finishes make it a timeless essential.',
  ...
  {
    id: 'manteau-long-laine-hugo-boss-cat-1-cat-2',
    name: 'Langer Wollmantel Hugo Boss',
    name_fr: 'Manteau Long en Laine Hugo Boss',
    name_en: 'Hugo Boss Long Wool Coat',
    slug: 'manteau-long-laine-hugo-boss-winter-clothing-mens-clothing',
    price: 750,
    description: 'Ein ikonischer langer Mantel aus einer luxuriösen Wollmischung, perfekt für einen eleganten Winterlook. Sein minimalistischer Schnitt und die tadellosen Oberflächen machen ihn zu einem zeitlosen Must-have.',
    description_fr: 'Un manteau long iconique dans un mélange de laine luxueux, parfait pour une allure hivernale élégante. Sa coupe minimaliste et ses finitions impeccables en font un indispensable intemporel.',
    description_en: 'An iconic long coat in a luxurious wool blend, perfect for an elegant winter look. Its minimalist cut and impeccable finishes make it a timeless essential.',
  ...
  },
  {
    ...
    name_fr: 'Pull Laine Merinos',
    name_en: 'Merino Wool Sweater',
    slug: 'pull-laine-merinos-lacoste-winter-clothing',
    price: 160,
    description: 'Die zeitlose Eleganz von Merinowolle. Dieser Pullover bietet unübertroffene Weichheit und natürliche Thermoregulation. Ein Must-Have für eine anspruchsvolle und komfortable Garderobe.',
    description_fr: 'L\'élégance intemporelle de la laine mérinos. Ce pull offre une douceur inégalée et une thermorégulation naturelle. Un indispensable pour une garde-robe sophistiquée et confortable.',
    description_en: 'The timeless elegance of merino wool. This sweater offers unparalleled softness and natural thermoregulation. An essential for a sophisticated and comfortable wardrobe.',
  ...
  {
    id: 'prod-43-cat-1-cat-2',
    name: 'Merino wollpullover',
    name_fr: 'Pull Laine Merinos',
    name_en: 'Merino Wool Sweater',
    slug: 'pull-laine-merinos-lacoste-winter-clothing-mens-clothing',
    price: 160,
    description: 'Die zeitlose Eleganz von Merinowolle. Dieser Pullover bietet unübertroffene Weichheit und natürliche Thermoregulation. Ein Must-Have für eine anspruchsvolle und komfortable Garderobe.',
    description_fr: 'L\'élégance intemporelle de la laine mérinos. Ce pull offre une douceur inégalée et une thermorégulation naturelle. Un indispensable pour une garde-robe sophistiquée et confortable.',
    description_en: 'The timeless elegance of merino wool. This sweater offers unparalleled softness and natural thermoregulation. An essential for a sophisticated and comfortable wardrobe.',
  ...
  {
    id: 'pull-col-roule-laine-merinos-paul-smith-cat-1',
    name: 'Merinowoll-Rollkragenpullover',
    name_fr: 'Pull Col Roulé Laine Merinos',
    name_en: 'Merino Wool Turtleneck Sweater',
    slug: 'pull-col-roule-laine-merinos-paul-smith-winter-clothing',
    price: 130,
    oldPrice: 180,
    description: 'Ein weicher und eleganter Rollkragenpullover aus Merinowolle. Ein Muss für Ihre Wintergarderobe.',
    description_fr: 'Un pull à col roulé doux et élégant en laine de mérinos. Un indispensable de votre garde-robe d\'hiver.',
  ...
  {
    id: 'pull-col-roule-laine-merinos-paul-smith-cat-1-cat-2',
    name: 'Merinowoll-Rollkragenpullover',
    name_fr: 'Pull Col Roulé Laine Merinos',
    name_en: 'Merino Wool Turtleneck Sweater',
    slug: 'pull-col-roule-laine-merinos-paul-smith-winter-clothing-mens-clothing',
    price: 130,
    oldPrice: 180,
    description: 'Ein weicher und eleganter Rollkragenpullover aus Merinowolle. Ein Muss für Ihre Wintergarderobe.',
    description_fr: 'Un pull à col roulé doux et élégant en laine de mérinos. Un indispensable de votre garde-robe d\'hiver.',
  ...
  },
  {
    ...
    name_fr: 'Parka en Duvet Cordura Ripstop Stone Island',
    name_en: 'Stone Island Cordura Ripstop Down Parka',
    slug: 'stone-island-cordura-ripstop-down-parka-winter-clothing',
    price: 1350,
    description: 'Ein technischer Parka aus reißfestem Cordura-Stoff, behandelt für Wasserbeständigkeit und gefüllt mit hochwertigen Daunen.',
    description_fr: 'Une parka technique fabriquée en tissu Cordura indéchirable, traitée pour être déperlante et garnie de duvet de haute qualité.',
    description_en: 'A technical parka made from ripstop Cordura fabric, treated to be water-repellent and filled with high-quality down.',
  ...
  {
    id: 'prod-92-cat-1-cat-2',
    name: 'Stone Island Cordura Ripstop Daunenparka',
    name_fr: 'Parka en Duvet Cordura Ripstop Stone Island',
    name_en: 'Stone Island Cordura Ripstop Down Parka',
    slug: 'stone-island-cordura-ripstop-down-parka-winter-clothing-womens-clothing',
    price: 1350,
    description: 'Ein technischer Parka aus reißfestem Cordura-Stoff, behandelt für Wasserbeständigkeit und gefüllt mit hochwertigen Daunen.',
    description_fr: 'Une parka technique fabriquée en tissu Cordura indéchirable, traitée pour être déperlante et garnie de duvet de haute qualité.',
    description_en: 'A technical parka made from ripstop Cordura fabric, treated to be water-repellent and filled with high-quality down.',
  ...
  },
  {
    ...
    name_fr: 'Veste Adidas by Stella McCartney',
    name_en: 'Adidas by Stella McCartney Jacket',
    slug: 'adidas-stella-mccartney-veste-sport',
    price: 280,
    description: 'Eine technische und schicke Jacke, perfekt für das Training bei kühlem Wetter, die Leistung und Stil vereint.',
    description_fr: 'Une veste technique et chic, parfaite pour les entraînements par temps frais, alliant performance et style.',
    description_en: 'A technical and chic jacket, perfect for cool weather training, combining performance and style.',
  ...
  {
    id: 'sport-101-cat-1-cat-2',
    name: 'Adidas by Stella McCartney Jacke',
    name_fr: 'Veste Adidas by Stella McCartney',
    name_en: 'Adidas by Stella McCartney Jacket',
    slug: 'adidas-stella-mccartney-veste-sport-mens-clothing',
    price: 280,
    description: 'Eine technische und schicke Jacke, perfekt für das Training bei kühlem Wetter, die Leistung und Stil vereint.',
    description_fr: 'Une veste technique et chic, parfaite pour les entraînements par temps frais, alliant performance et style.',
    description_en: 'A technical and chic jacket, perfect for cool weather training, combining performance and style.',
  ...
  },
  {
    ...
    name_fr: 'Veste Zippée Alo Yoga',
    name_en: 'Alo Yoga Zip Jacket',
    slug: 'alo-yoga-veste-zippee-sport',
    price: 180,
    description: 'Eine weiche und bequeme Reißverschlussjacke, ideal zum Aufwärmen oder für einen lässigen Look nach dem Yoga.',
    description_fr: 'Une veste zippée douce et confortable, idéale pour l\'échauffement ou pour un look décontracté post-yoga.',
    description_en: 'A soft and comfortable zip jacket, ideal for warm-ups or for a casual post-yoga look.',
  ...
  {
    id: 'sport-103-cat-1-cat-2',
    name: 'Alo Yoga Reißverschlussjacke',
    name_fr: 'Veste Zippée Alo Yoga',
    name_en: 'Alo Yoga Zip Jacket',
    slug: 'alo-yoga-veste-zippee-sport-mens-clothing',
    price: 180,
    description: 'Eine weiche und bequeme Reißverschlussjacke, ideal zum Aufwärmen oder für einen lässigen Look nach dem Yoga.',
    description_fr: 'Une veste zippée douce et confortable, idéale pour l\'échauffement ou pour un look décontracté post-yoga.',
    description_en: 'A soft and comfortable zip jacket, ideal for warm-ups or for a casual post-yoga look.',
  ...
  },
  {
    ...
    name_fr: 'Veste Active Storm Loewe x On',
    name_en: 'Loewe x On Storm Active Jacket',
    slug: 'loewe-on-storm-active-jacket-sport',
    price: 450,
    description: 'Eine technische Jacke, die für alle Bedingungen konzipiert wurde und Sie vor den Elementen schützt, ohne den Stil zu beeinträchtigen.',
    description_fr: 'Une veste technique conçue pour toutes les conditions, vous protégeant des éléments sans compromis sur le style.',
    description_en: 'A technical jacket designed for all conditions, protecting you from the elements without compromising on style.',
  ...
  {
    id: 'sport-109-cat-1-cat-2',
    name: 'Loewe x On Storm Active Jacke',
    name_fr: 'Veste Active Storm Loewe x On',
    name_en: 'Loewe x On Storm Active Jacket',
    slug: 'loewe-on-storm-active-jacket-sport-mens-clothing',
    price: 450,
    description: 'Eine technische Jacke, die für alle Bedingungen konzipiert wurde und Sie vor den Elementen schützt, ohne den Stil zu beeinträchtigen.',
    description_fr: 'Une veste technique conçue pour toutes les conditions, vous protégeant des éléments sans compromis sur le style.',
    description_en: 'A technical jacket designed for all conditions, protecting you from the elements without compromising on style.',
  ...
  },
  {
    ...
    name_fr: 'Veste de Survetement Diesel Sport',
    name_en: 'Diesel Sport Track Jacket',
    slug: 'diesel-sport-track-jacket-sport',
    price: 210,
    description: 'Eine Trainingsjacke mit Retro-Look und modernem Touch, perfekt für einen sportlichen und trendigen Stil.',
    description_fr: 'Une veste de survêtement au look rétro avec une touche moderne, parfaite pour un style sportif et tendance.',
    description_en: 'A retro-look track jacket with a modern twist, perfect for a sporty and trendy style.',
  ...
  {
    id: 'sport-111-cat-1-cat-2',
    name: 'Diesel Sport Trainingsjacke',
    name_fr: 'Veste de Survetement Diesel Sport',
    name_en: 'Diesel Sport Track Jacket',
    slug: 'diesel-sport-track-jacket-sport-mens-clothing',
    price: 210,
    description: 'Eine Trainingsjacke mit Retro-Look und modernem Touch, perfekt für einen sportlichen und trendigen Stil.',
    description_fr: 'Une veste de survêtement au look rétro avec une touche moderne, parfaite pour un style sportif et tendance.',
    description_en: 'A retro-look track jacket with a modern twist, perfect for a sporty and trendy style.',
  ...
  },
  {
    ...
    name_fr: 'Combinaison de Yoga en Laine Nagnata',
    name_en: 'Nagnata Wool Yoga Jumpsuit',
    slug: 'nagnata-laine-combinaison-yoga-sport',
    price: 350,
    description: 'Eine elegante und bequeme Yoga-Kombination aus Merinowolle für eine luxuriöse Praxis.',
    description_fr: 'Une combinaison de yoga élégante et confortable en laine mérinos pour une pratique luxueuse.',
    description_en: 'An elegant and comfortable merino wool yoga jumpsuit for a luxurious practice.',
  ...
  {
    id: 'sport-112-cat-1-cat-2',
    name: 'Nagnata Woll-Yoga-Overall',
    name_fr: 'Combinaison de Yoga en Laine Nagnata',
    name_en: 'Nagnata Wool Yoga Jumpsuit',
    slug: 'nagnata-laine-combinaison-yoga-sport-winter-clothing',
    price: 350,
    description: 'Eine elegante und bequeme Yoga-Kombination aus Merinowolle für eine luxuriöse Praxis.',
    description_fr: 'Une combinaison de yoga élégante et confortable en laine mérinos pour une pratique luxueuse.',
    description_en: 'An elegant and comfortable merino wool yoga jumpsuit for a luxurious practice.',
  ...
  },
  {
    ...
    name_fr: 'Veste Premium Lululemon',
    name_en: 'Lululemon Premium Jacket',
    slug: 'lululemon-veste-premium-sport',
    price: 250,
    description: 'Eine hochwertige Jacke, die Leistung und Ästhetik für einen anspruchsvollen sportlichen Look vereint.',
    description_fr: 'Une veste de qualité supérieure qui combine performance et esthétique pour un look sportif sophistiqué.',
    description_en: 'A premium jacket that combines performance and aesthetics for a sophisticated sporty look.',
  ...
  {
    id: 'sport-113-cat-1-cat-2',
    name: 'Lululemon Premium Jacke',
    name_fr: 'Veste Premium Lululemon',
    name_en: 'Lululemon Premium Jacket',
    slug: 'lululemon-veste-premium-sport-mens-clothing',
    price: 250,
    description: 'Eine hochwertige Jacke, die Leistung und Ästhetik für einen anspruchsvollen sportlichen Look vereint.',
    description_fr: 'Une veste de qualité supérieure qui combine performance et esthétique pour un look sportif sophistiqué.',
    description_en: 'A premium jacket that combines performance and aesthetics for a sophisticated sporty look.',
  ...
  },
  {
    ...
    name_fr: 'Veste Technique Peak Performance',
    name_en: 'Peak Performance Tech Jacket',
    slug: 'peak-performance-tech-jacket-sport',
    price: 300,
    description: 'Eine technische Jacke für Outdoor-Abenteuer, die optimalen Schutz und große Bewegungsfreiheit bietet.',
    description_fr: 'Une veste technique pour les aventures en plein air, offrant une protection optimale et une grande liberté de mouvement.',
    description_en: 'A technical jacket for outdoor adventures, offering optimal protection and great freedom of movement.',
  ...
  {
    id: 'sport-114-cat-1-cat-2',
    name: 'Peak Performance Tech Jacke',
    name_fr: 'Veste Technique Peak Performance',
    name_en: 'Peak Performance Tech Jacket',
    slug: 'peak-performance-tech-jacket-sport-mens-clothing',
    price: 300,
    description: 'Eine technische Jacke für Outdoor-Abenteuer, die optimalen Schutz und große Bewegungsfreiheit bietet.',
    description_fr: 'Une veste technique pour les aventures en plein air, offrant une protection optimale et une grande liberté de mouvement.',
    description_en: 'A technical jacket for outdoor adventures, offering optimal protection and great freedom of movement.',
  ...
  {
    id: 'sport-118-cat-1-cat-2',
    name: 'Bogner Ski Parka',
    name_fr: 'Parka de Ski Bogner',
    name_en: 'Bogner Ski Parka',
    slug: 'bogner-ski-parka-sport-winter-clothing',
    price: 750,
    oldPrice: 1200,
    description: 'Ein High-End-Skiparka, der Eleganz und Leistung für einen tadellosen Stil auf der Piste vereint.',
    description_fr: 'Une parka de ski haut de gamme qui allie élégance et performance pour un style impeccable sur les pistes.',
  ...
  },
  {
    ...
    name_fr: 'Sac d\'hiver matelassé',
    name_en: 'Quilted Winter Bag',
    slug: 'sac-hiver-matelasse-winter-clothing',
    price: 180,
    oldPrice: 220,
    description: 'Eine schicke und funktionale Tasche für den Winter, mit einer weichen Polsterung, um Ihre Sachen warm zu halten.',
    description_fr: 'Un sac chic et fonctionnel pour l\'hiver, avec un rembourrage doux pour garder vos affaires au chaud.',
  ...
  {
    id: 'sac_hiver1-cat-1-cat-2',
    name: 'Gepolsterte Wintertasche',
    name_fr: 'Sac d\'hiver matelassé',
    name_en: 'Quilted Winter Bag',
    slug: 'sac-hiver-matelasse-winter-clothing-accessories',
    price: 180,
    oldPrice: 220,
    description: 'Eine schicke und funktionale Tasche für den Winter, mit einer weichen Polsterung, um Ihre Sachen warm zu halten.',
    description_fr: 'Un sac chic et fonctionnel pour l\'hiver, avec un rembourrage doux pour garder vos affaires au chaud.',
  ...
  },
  {
    ...
    name_fr: 'Sac à dos d\'hiver Explorer',
    name_en: 'Explorer Winter Backpack',
    slug: 'sac-a-dos-hiver-explorer-winter-clothing',
    price: 250,
    description: 'Ein robuster und geräumiger Rucksack, der für Winterabenteuer konzipiert wurde, mit mehreren Fächern und wasserdichten Materialien.',
    description_fr: 'Un sac à dos robuste et spacieux conçu pour les aventures hivernales, avec de multiples compartiments et des matériaux résistants à l\'eau.',
    description_en: 'A sturdy and spacious backpack designed for winter adventures, with multiple compartments and water-resistant materials.',
  ...
  {
    id: 'sac_hiver2-cat-1-cat-2',
    name: 'Explorer Winterrucksack',
    name_fr: 'Sac à dos d\'hiver Explorer',
    name_en: 'Explorer Winter Backpack',
    slug: 'sac-a-dos-hiver-explorer-winter-clothing-accessories',
    price: 250,
    description: 'Ein robuster und geräumiger Rucksack, der für Winterabenteuer konzipiert wurde, mit mehreren Fächern und wasserdichten Materialien.',
    description_fr: 'Un sac à dos robuste et spacieux conçu pour les aventures hivernales, avec de multiples compartiments et des matériaux résistants à l\'eau.',
    description_en: 'A sturdy and spacious backpack designed for winter adventures, with multiple compartments and water-resistant materials.',
  ...
  },
  {
    ...
    name_fr: 'Cabas en laine de luxe',
    name_en: 'Luxury Wool Tote Bag',
    slug: 'cabas-laine-luxe-winter-clothing',
    price: 320,
    description: 'Eine elegante Tragetasche aus hochwertiger Wolle, perfekt für einen raffinierten Winterlook.',
    description_fr: 'Un sac cabas élégant en laine de haute qualité, parfait pour un look hivernal sophistiqué.',
    description_en: 'An elegant tote bag made of high-quality wool, perfect for a sophisticated winter look.',
  ...
  {
    id: 'sac_hiver3-cat-1-cat-2',
    name: 'Luxuriöse Woll-Tragetasche',
    name_fr: 'Cabas en laine de luxe',
    name_en: 'Luxury Wool Tote Bag',
    slug: 'cabas-laine-luxe-winter-clothing-accessories',
    price: 320,
    description: 'Eine elegante Tragetasche aus hochwertiger Wolle, perfekt für einen raffinierten Winterlook.',
    description_fr: 'Un sac cabas élégant en laine de haute qualité, parfait pour un look hivernal sophistiqué.',
    description_en: 'An elegant tote bag made of high-quality wool, perfect for a sophisticated winter look.',
  ...
  },
  {
    ...
    name_fr: 'Sac bandoulière compact d\'hiver',
    name_en: 'Compact Winter Crossbody Bag',
    slug: 'sac-bandouliere-hiver-compact-winter-clothing',
    price: 150,
    description: 'Eine kleine und praktische Umhängetasche, ideal, um das Nötigste im Winter stilvoll bei sich zu tragen.',
    description_fr: 'Un petit sac bandoulière pratique, idéal pour transporter vos essentiels avec style pendant l\'hiver.',
    description_en: 'A small and practical crossbody bag, ideal for carrying your essentials in style during the winter.',
  ...
  {
    id: 'sac_hiver4-cat-1-cat-2',
    name: 'Kompakte Winter-Umhängetasche',
    name_fr: 'Sac bandoulière compact d\'hiver',
    name_en: 'Compact Winter Crossbody Bag',
    slug: 'sac-bandouliere-hiver-compact-winter-clothing-accessories',
    price: 150,
    description: 'Eine kleine und praktische Umhängetasche, ideal, um das Nötigste im Winter stilvoll bei sich zu tragen.',
    description_fr: 'Un petit sac bandoulière pratique, idéal pour transporter vos essentiels avec style pendant l\'hiver.',
    description_en: 'A small and practical crossbody bag, ideal for carrying your essentials in style during the winter.',
  ...
  },
  {
    ...
    name_fr: 'Montre Sport en Silicone',
    name_en: 'Silicone Sport Watch',
    slug: 'montre-sport-silicone-hydrosport-5-atm-sport',
    price: 120,
    description: 'Eine langlebige und stilvolle Uhr für den aktiven Lebensstil. Wasserdicht und komfortabel.',
    description_fr: 'Une montre durable et élégante pour le style de vie actif. Résistante à l\'eau et confortable.',
    description_en: 'A durable and stylish watch for the active lifestyle. Water-resistant and comfortable.',
  ...
  {
    id: 'acc-101-cat-1-cat-2',
    name: 'Silikon-Sportuhr',
    name_fr: 'Montre Sport en Silicone',
    name_en: 'Silicone Sport Watch',
    slug: 'montre-sport-silicone-hydrosport-5-atm-sport-accessories',
    price: 120,
    description: 'Eine langlebige und stilvolle Uhr für den aktiven Lebensstil. Wasserdicht und komfortabel.',
    description_fr: 'Une montre durable et élégante pour le style de vie actif. Résistante à l\'eau et confortable.',
    description_en: 'A durable and stylish watch for the active lifestyle. Water-resistant and comfortable.',
  ...
  },
  {
    ...
    name_fr: 'Manteau Long en Laine Ceinturé',
    name_en: 'Long Belted Wool Coat',
    slug: 'manteau-long-laine-ceinture-femme1-womens-clothing',
    price: 890,
    oldPrice: 1200,
    description: 'Ein Meisterwerk der Eleganz. Dieser lange Mantel aus reiner Wolle mit seinem passenden Gürtel betont die Taille und schafft eine anmutige und zeitlose Silhouette.',
    description_fr: 'Un chef-d\'œuvre d\'élégance. Ce manteau long en pure laine, avec sa ceinture assortie, souligne la taille pour une silhouette gracieuse et intemporelle.',
  ...
  },
  {
    ...
    name_fr: 'Manteau Long en Laine Ceinturé',
    name_en: 'Long Belted Wool Coat',
    slug: 'manteau-long-laine-ceinture-femme1-winter-clothing',
    price: 890,
    oldPrice: 1200,
    description: 'Ein Meisterwerk der Eleganz. Dieser lange Mantel aus reiner Wolle mit seinem passenden Gürtel betont die Taille und schafft eine anmutige und zeitlose Silhouette.',
    description_fr: 'Un chef-d\'œuvre d\'élégance. Ce manteau long en pure laine, avec sa ceinture assortie, souligne la taille pour une silhouette gracieuse et intemporelle.',
  ...
  },
  {
    ...
    name_fr: 'Manteau Long Croisé',
    name_en: 'Long Double-Breasted Coat',
    slug: 'manteau-long-croise-femme2-womens-clothing',
    price: 950,
    oldPrice: 1350,
    description: 'Strukturierte Eleganz für diesen langen zweireihigen Mantel. Sein scharfer Schnitt und die imposante Schulterpartie verleihen einen kraftvollen und anspruchsvollen Look.',
    description_fr: 'L\'élégance structurée pour ce manteau long croisé. Sa coupe franche et sa carrure imposante confèrent une allure puissante et sophistiquée.',
  ...
  },
  {
    ...
    name_fr: 'Manteau Long Croisé',
    name_en: 'Long Double-Breasted Coat',
    slug: 'manteau-long-croise-femme2-winter-clothing',
    price: 950,
    oldPrice: 1350,
    description: 'Strukturierte Eleganz für diesen langen zweireihigen Mantel. Sein scharfer Schnitt und die imposante Schulterpartie verleihen einen kraftvollen und anspruchsvollen Look.',
    description_fr: 'L\'élégance structurée pour ce manteau long croisé. Sa coupe franche et sa carrure imposante confèrent une allure puissante et sophistiquée.',
  ...
  },
  {
    ...
    name_fr: 'Manteau Long en Cachemire',
    name_en: 'Long Cashmere Coat',
    slug: 'manteau-long-cachemire-femme3-womens-clothing',
    price: 1500,
    oldPrice: 2200,
    description: 'Hüllen Sie sich in absoluten Luxus mit diesem langen Mantel aus reinem Kaschmir. Seine unvergleichliche Weichheit und sein fließender Fall sind eine Einladung zu Komfort und Raffinesse.',
    description_fr: 'Enveloppez-vous de luxe absolu avec ce manteau long en pur cachemire. Sa douceur inégalée et son tombé fluide sont une invitation au confort et au raffinement.',
  ...
  },
  {
    ...
    name_fr: 'Manteau Long en Cachemire',
    name_en: 'Long Cashmere Coat',
    slug: 'manteau-long-cachemire-femme3-winter-clothing',
    price: 1500,
    oldPrice: 2200,
    description: 'Hüllen Sie sich in absoluten Luxus mit diesem langen Mantel aus reinem Kaschmir. Seine unvergleichliche Weichheit und sein fließender Fall sind eine Einladung zu Komfort und Raffinesse.',
    description_fr: 'Enveloppez-vous de luxe absolu avec ce manteau long en pur cachemire. Sa douceur inégalée et son tombé fluide sont une invitation au confort et au raffinement.',
  ...
  },
  {
    ...
    name_fr: 'Manteau Long Botega veneta ',
    name_en: 'Long Coat Botega veneta',
    slug: 'manteau-long-fausse-fourrure-femme4-womens-clothing',
    price: 780,
    oldPrice: 1100,
    description: 'Ein glamouröser und gewagter Stil. Dieser lange Mantel aus luxuriösem Kunstpelz verspricht einen spektakulären Auftritt und gemütliche Wärme.',
    description_fr: 'Une allure glamour et audacieuse. Ce manteau long en fausse fourrure luxueuse promet une entrée spectaculaire et une chaleur réconfortante.',
  ...
  },
  {
    ...
    name_fr: 'Manteau Long Botega veneta ',
    name_en: 'Long Coat Botega veneta',
    slug: 'manteau-long-fausse-fourrure-femme4-winter-clothing',
    price: 780,
    oldPrice: 1100,
    description: 'Ein glamouröser und gewagter Stil. Dieser lange Mantel aus luxuriösem Kunstpelz verspricht einen spektakulären Auftritt und gemütliche Wärme.',
    description_fr: 'Une allure glamour et audacieuse. Ce manteau long en fausse fourrure luxueuse promet une entrée spectaculaire et une chaleur réconfortante.',
  ...
  },
  {
    ...
    name_fr: 'Manteau Long à Col Châle ZARA',
    name_en: 'Long Shawl Collar Coat ZARA',
    slug: 'manteau-long-col-chale-femme5-womens-clothing',
    price: 820,
    oldPrice: 1150,
    description: 'Ein umhüllender und raffinierter langer Mantel. Sein großzügiger Schalkragen und der weiche Wollstoff schaffen eine Silhouette, die sowohl schick als auch entspannt ist.',
    description_fr: 'Un manteau long enveloppant et raffiné. Son col châle généreux et son drap de laine souple créent une silhouette à la fois chic et décontractée.',
  ...
  },
  {
    ...
    name_fr: 'Manteau Long à Col Châle ZARA',
    name_en: 'Long Shawl Collar Coat ZARA',
    slug: 'manteau-long-col-chale-femme5-winter-clothing',
    price: 820,
    oldPrice: 1150,
    description: 'Ein umhüllender und raffinierter langer Mantel. Sein großzügiger Schalkragen und der weiche Wollstoff schaffen eine Silhouette, die sowohl schick als auch entspannt ist.',
    description_fr: 'Un manteau long enveloppant et raffiné. Son col châle généreux et son drap de laine souple créent une silhouette à la fois chic et décontractée.',
  ...
  },
  {
    ...
    name_fr: 'Manteau Long Oversize ZARA',
    name_en: 'Long Oversize Coat ZARA',
    slug: 'manteau-long-oversize-femme6-womens-clothing',
    price: 489,
    oldPrice: 700,
    description: 'Ein starkes Modestatement. Dieser lange Oversize-Mantel spielt mit Volumen für einen modernen und avantgardistischen Look, ohne auf Komfort und Wärme zu verzichten.',
    description_fr: 'Une déclaration de mode forte. Ce manteau long oversize joue avec les volumes pour une allure moderne et avant-gardiste, sans compromis sur le confort et la chaleur.',
  ...
  },
  {
    ...
    name_fr: 'Manteau Long Oversize ZARA',
    name_en: 'Long Oversize Coat ZARA',
    slug: 'manteau-long-oversize-femme6-winter-clothing',
    price: 489,
    oldPrice: 700,
    description: 'Ein starkes Modestatement. Dieser lange Oversize-Mantel spielt mit Volumen für einen modernen und avantgardistischen Look, ohne auf Komfort und Wärme zu verzichten.',
    description_fr: 'Une déclaration de mode forte. Ce manteau long oversize joue avec les volumes pour une allure moderne et avant-gardiste, sans compromis sur le confort et la chaleur.',
  ...
  },
  {
    ...
    name: 'Broche mit Logo und Kristallen',
    name_fr: 'Broche Logo Cristaux',
    name_en: 'Logo Crystal Brooch',
    slug: 'broche-logo-cristaux',
    price: 85,
    description: 'Eine elegante Broche mit Logo und funkelnden Kristallen.',
    description_fr: 'Une broche élégante avec logo et cristaux scintillants.',
    description_en: 'An elegant brooch with logo and sparkling crystals.',
    category: 'accessories',
    images: ['Broche_Logo_Cristaux'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Gold', name_fr: 'Doré', name_en: 'Gold' }],
  },
  {
    id: 'carr-de-soie-imprim',
    name: 'Seidenschal mit Druck',
    name_fr: 'Carré de Soie Imprimé',
    name_en: 'Printed Silk Scarf',
    slug: 'carr-de-soie-imprim',
    price: 120,
    description: 'Ein luxuriöser Seidenschal mit elegantem Druck.',
    description_fr: 'Un carré de soie luxueux avec impression élégante.',
    description_en: 'A luxurious silk scarf with elegant print.',
    category: 'accessories',
    images: ['Carré_de_Soie_Imprimé'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Multicolor', name_fr: 'Multicolore', name_en: 'Multicolor' }],
  },
  {
    id: 'ceinture-en-cuir-logo',
    name: 'Ledergürtel mit Logo',
    name_fr: 'Ceinture en Cuir Logo',
    name_en: 'Logo Leather Belt',
    slug: 'ceinture-en-cuir-logo',
    price: 95,
    description: 'Ein hochwertiger Ledergürtel mit Logo-Prägung.',
    description_fr: 'Une ceinture en cuir de qualité supérieure avec logo estampé.',
    description_en: 'A high-quality leather belt with logo embossing.',
    category: 'accessories',
  ...
  },
  {
    ...
    name: 'Sonnenbrille im Katzenaugen-Stil',
    name_fr: 'Lunettes de Soleil Oeil de Chat',
    name_en: 'Cat Eye Sunglasses',
    slug: 'lunettes-de-soleil-oeil-de-chat',
    price: 150,
    description: 'Eine elegante Sonnenbrille im Katzenaugen-Stil mit UV-Schutz.',
    description_fr: 'Des lunettes de soleil élégantes style œil de chat avec protection UV.',
    description_en: 'Elegant cat-eye style sunglasses with UV protection.',
    category: 'accessories',
  ...
  {
    id: 'manchette-en-mtal-dor',
    name: 'Manschettenknöpfe aus vergoldetem Metall',
    name_fr: 'Manchette en Métal Doré',
    name_en: 'Gold Metal Cufflinks',
    slug: 'manchette-en-mtal-dor',
    price: 75,
    description: 'Raffinierte Manschettenknöpfe aus vergoldetem Metall.',
    description_fr: 'Des boutons de manchette raffinés en métal doré.',
    description_en: 'Refined gold metal cufflinks.',
    category: 'mens-clothing',
  ...
  {
    id: 'manchette-en-mtal-dor-cat-1',
    name: 'Manschettenknöpfe aus vergoldetem Metall',
    name_fr: 'Manchette en Métal Doré',
    name_en: 'Gold Metal Cufflinks',
    slug: 'manchette-en-mtal-dor-accessories',
    price: 75,
    description: 'Raffinierte Manschettenknöpfe aus vergoldetem Metall.',
    description_fr: 'Des boutons de manchette raffinés en métal doré.',
    description_en: 'Refined gold metal cufflinks.',
  ...
  {
    id: 'manchette-en-mtal-dor-cat-1-cat-2',
    name: 'Manschettenknöpfe aus vergoldetem Metall',
    name_fr: 'Manchette en Métal Doré',
    name_en: 'Gold Metal Cufflinks',
    slug: 'manchette-en-mtal-dor-accessories-mens-clothing',
    price: 75,
    description: 'Raffinierte Manschettenknöpfe aus vergoldetem Metall.',
    description_fr: 'Des boutons de manchette raffinés en métal doré.',
    description_en: 'Refined gold metal cufflinks.',
  ...
  {
    id: 'porte-cartes-en-cuir-matelass',
    name: 'Kartenetui aus geprägtem Leder',
    name_fr: 'Porte-cartes en Cuir Matelassé',
    name_en: 'Quilted Leather Card Holder',
    slug: 'porte-cartes-en-cuir-matelass',
    price: 65,
    description: 'Ein kompaktes Kartenetui aus hochwertigem geprägtem Leder.',
    description_fr: 'Un porte-cartes compact en cuir matelassé de qualité supérieure.',
    description_en: 'A compact card holder in high-quality quilted leather.',
    category: 'accessories',
  ...
  },
  {
    ...
    price: 280,
    description: 'Eine ikonische Ledertasche, die Eleganz und Funktionalität vereint.',
    description_fr: 'Un sac en cuir iconique alliant élégance et fonctionnalité.',
    description_en: 'An iconic leather bag combining elegance and functionality.',
    category: 'accessories',
  ...
  {
    id: 'sac-seau-en-cuir',
    name: 'Ledereimer-Tasche',
    name_fr: 'Sac Seau en Cuir',
    name_en: 'Leather Bucket Bag',
    slug: 'sac-seau-en-cuir',
    price: 280,
    description: 'Eine trendige Ledereimer-Tasche. Geräumig und stilvoll.',
    description_fr: 'Un sac seau en cuir tendance. Spacieux et stylé.',
    description_en: 'A trendy leather bucket bag. Spacious and stylish.',
    category: 'accessories',
  ...
  {
    id: 'serre-tte-en-velours-rembourr',
    name: 'Velours-Kopfband mit Polsterung',
    name_fr: 'Serre-tête en Velours Rembourré',
    name_en: 'Padded Velvet Headband',
    slug: 'serre-tte-en-velours-rembourr',
    price: 45,
    description: 'Ein komfortables Kopfband aus Velours mit Polsterung.',
    description_fr: 'Un serre-tête confortable en velours rembourré.',
    description_en: 'A comfortable padded velvet headband.',
    category: 'accessories',
  ...
  },
  {
    ...
    name: 'Satinbluse Stella McCartney',
    name_fr: 'Blouse Satinée Stella McCartney',
    name_en: 'Satin Blouse Stella McCartney',
    slug: 'blouse-satinee-stella-mccartney',
    price: 320,
    description: 'Eine elegante Satinbluse von Stella McCartney.',
    description_fr: 'Une blouse élégante en satin de Stella McCartney.',
    description_en: 'An elegant satin blouse by Stella McCartney.',
    category: 'womens-clothing',
  ...
  },
  {
    ...
    name: 'Shearling-Blouson Saint Laurent',
    name_fr: 'Blouson Shearling Saint Laurent',
    name_en: 'Shearling Jacket Saint Laurent',
    slug: 'blouson-shearling-saint-laurent',
    price: 1850,
    description: 'Ein luxuriöses Shearling-Blouson von Saint Laurent.',
    description_fr: 'Un blouson shearling luxueux de Saint Laurent.',
    description_en: 'A luxurious shearling jacket by Saint Laurent.',
    category: 'womens-clothing',
    // subcategory: 'womens-clothing',
  ...
  },
  {
    ...
    name: 'Langer Kaschmir-Cardigan Brunello Cucinelli',
    name_fr: 'Cardigan Long en Cachemire Brunello Cucinelli',
    name_en: 'Long Cashmere Cardigan Brunello Cucinelli',
    slug: 'cardigan-long-en-cachemire-brunello-cucinelli',
    price: 890,
    description: 'Ein luxuriöser langer Cardigan aus reinem Kaschmir von Brunello Cucinelli.',
    description_fr: 'Un cardigan long luxueux en pur cachemire de Brunello Cucinelli.',
    description_en: 'A luxurious long cardigan in pure cashmere by Brunello Cucinelli.',
    category: 'winter-clothing',
    // subcategory: 'winter-clothing',
    images: ['cardigan-long-en-cachemire-brunello-cucinelli'],
    sizes: ['S', 'M', 'L', 'XL'],
    colors: [{ name_de: 'Braun', name_fr: 'Marron', name_en: 'Brown' }, { name_de: 'Beige', name_fr: 'Beige', name_en: 'Beige' }],
  },
  {
    ...
    price: 100,
    description: 'Ein elegantes Produkt. Hochwertige Materialien und zeitloser Stil.',
    description_fr: 'Un produit élégant. Matériaux de qualité supérieure et style intemporel.',
    description_en: 'An elegant product. High-quality materials and timeless style.',
    category: 'mens-clothing',
  ...
  },
  {
    ...
    name: 'Seidenbluse mit Druck Saint Laurent',
    name_fr: 'Chemisier en Soie Imprimée Saint Laurent',
    name_en: 'Printed Silk Blouse Saint Laurent',
    slug: 'chemisier-en-soie-imprimee-saint-laurent',
    price: 450,
    description: 'Eine luxuriöse Seidenbluse mit elegantem Druck von Saint Laurent.',
    description_fr: 'Un chemisier luxueux en soie imprimée de Saint Laurent.',
    description_en: 'A luxurious silk blouse with elegant print by Saint Laurent.',
    category: 'womens-clothing',
    // subcategory: 'womens-clothing',
  ...
  },
  {
    ...
    name: 'Elegante Hose',
    name_fr: 'Pantalon Élégant',
    name_en: 'Elegant Trousers',
    slug: 'combinaison-pantalon-balenciaga',
    price: 150,
    description: 'Eine elegante Hose aus hochwertigen Materialien.',
    description_fr: 'Un pantalon élégant en matériaux de qualité supérieure.',
    description_en: 'An elegant trouser made of high-quality materials.',
    category: 'mens-clothing',
  ...
  {
    id: 'doudoune-sans-manche-polo-ralph-lauren-cat-1',
    name: 'Doudoune Sans Manche Polo Ralph Lauren',
    name_fr: 'Doudoune Sans Manche Polo Ralph Lauren',
    name_en: 'Doudoune Sans Manche Polo Ralph Lauren',
    slug: 'doudoune-sans-manche-polo-ralph-lauren-winter-clothing',
    price: 100,
    description: 'Ein elegantes Produkt. Hochwertige Materialien und zeitloser Stil.',
    description_fr: 'Un produit élégant. Matériaux de qualité supérieure et style intemporel.',
    description_en: 'An elegant product. High-quality materials and timeless style.',
  ...
  {
    id: 'doudoune-sans-manche-polo-ralph-lauren-cat-1-cat-2',
    name: 'Doudoune Sans Manche Polo Ralph Lauren',
    name_fr: 'Doudoune Sans Manche Polo Ralph Lauren',
    name_en: 'Doudoune Sans Manche Polo Ralph Lauren',
    slug: 'doudoune-sans-manche-polo-ralph-lauren-winter-clothing-mens-clothing',
    price: 100,
    description: 'Ein elegantes Produkt. Hochwertige Materialien und zeitloser Stil.',
    description_fr: 'Un produit élégant. Matériaux de qualité supérieure et style intemporel.',
    description_en: 'An elegant product. High-quality materials and timeless style.',
  ...
  },
  {
    ...
    name: 'Bedrucktes Kapuzen-Sweatshirt Palm Angels',
    name_fr: 'Hoodie Imprimé Palm Angels',
    name_en: 'Printed Hoodie Palm Angels',
    slug: 'hoodie-imprime-palm-angels',
    price: 320,
    description: 'Ein trendiges bedrucktes Kapuzen-Sweatshirt von Palm Angels.',
    description_fr: 'Un hoodie imprimé tendance de Palm Angels.',
    description_en: 'A trendy printed hoodie by Palm Angels.',
    category: 'sport',
  ...
  },
  {
    ...
    name: 'Bleistiftrock aus Wolle Hugo Boss',
    name_fr: 'Jupe Crayon en Laine Hugo Boss',
    name_en: 'Wool Pencil Skirt Hugo Boss',
    slug: 'jupe-crayon-en-laine-hugo-boss',
    price: 180,
    description: 'Ein eleganter Bleistiftrock aus Wolle von Hugo Boss.',
    description_fr: 'Une jupe crayon élégante en laine de Hugo Boss.',
    description_en: 'An elegant wool pencil skirt by Hugo Boss.',
    category: 'womens-clothing',
    // subcategory: 'womens-clothing',
  ...
  {
    id: 'jupe-crayon-en-laine-hugo-boss-cat-1',
    name: 'Bleistiftrock aus Wolle Hugo Boss',
    name_fr: 'Jupe Crayon en Laine Hugo Boss',
    name_en: 'Wool Pencil Skirt Hugo Boss',
    slug: 'jupe-crayon-en-laine-hugo-boss-winter-clothing',
    price: 180,
    description: 'Ein eleganter Bleistiftrock aus Wolle von Hugo Boss.',
    description_fr: 'Une jupe crayon élégante en laine de Hugo Boss.',
    description_en: 'An elegant wool pencil skirt by Hugo Boss.',
  ...
  {
    id: 'jupe-crayon-en-laine-hugo-boss-cat-1-cat-2',
    name: 'Bleistiftrock aus Wolle Hugo Boss',
    name_fr: 'Jupe Crayon en Laine Hugo Boss',
    name_en: 'Wool Pencil Skirt Hugo Boss',
    slug: 'jupe-crayon-en-laine-hugo-boss-winter-clothing-womens-clothing',
    price: 180,
    description: 'Ein eleganter Bleistiftrock aus Wolle von Hugo Boss.',
    description_fr: 'Une jupe crayon élégante en laine de Hugo Boss.',
    description_en: 'An elegant wool pencil skirt by Hugo Boss.',
  ...
  {
    id: 'manteau-long-en-cachemire-max-mara-cat-1',
    name: 'Manteau Long En Cachemire Max Mara',
    name_fr: 'Manteau Long En Cachemire Max Mara',
    name_en: 'Manteau Long En Cachemire Max Mara',
    slug: 'manteau-long-en-cachemire-max-mara-winter-clothing',
    price: 100,
    description: 'Ein elegantes Produkt. Hochwertige Materialien und zeitloser Stil.',
    description_fr: 'Un produit élégant. Matériaux de qualité supérieure et style intemporel.',
    description_en: 'An elegant product. High-quality materials and timeless style.',
  ...
  {
    id: 'manteau-long-en-cachemire-max-mara-cat-1-cat-2',
    name: 'Manteau Long En Cachemire Max Mara',
    name_fr: 'Manteau Long En Cachemire Max Mara',
    name_en: 'Manteau Long En Cachemire Max Mara',
    slug: 'manteau-long-en-cachemire-max-mara-winter-clothing-mens-clothing',
    price: 100,
    description: 'Ein elegantes Produkt. Hochwertige Materialien und zeitloser Stil.',
    description_fr: 'Un produit élégant. Matériaux de qualité supérieure et style intemporel.',
    description_en: 'An elegant product. High-quality materials and timeless style.',
  ...
  {
    id: 'manteau-oversize-acne-studios-cat-1',
    name: 'Manteau Oversize Acne Studios',
    name_fr: 'Manteau Oversize Acne Studios',
    name_en: 'Manteau Oversize Acne Studios',
    slug: 'manteau-oversize-acne-studios-winter-clothing',
    price: 100,
    description: 'Ein elegantes Produkt. Hochwertige Materialien und zeitloser Stil.',
    description_fr: 'Un produit élégant. Matériaux de qualité supérieure et style intemporel.',
    description_en: 'An elegant product. High-quality materials and timeless style.',
  ...
  {
    id: 'manteau-oversize-acne-studios-cat-1-cat-2',
    name: 'Manteau Oversize Acne Studios',
    name_fr: 'Manteau Oversize Acne Studios',
    name_en: 'Manteau Oversize Acne Studios',
    slug: 'manteau-oversize-acne-studios-winter-clothing-mens-clothing',
    price: 100,
    description: 'Ein elegantes Produkt. Hochwertige Materialien und zeitloser Stil.',
    description_fr: 'Un produit élégant. Matériaux de qualité supérieure et style intemporel.',
    description_en: 'An elegant product. High-quality materials and timeless style.',
  ...
  {
    id: 'manteau-trench-double-burberry-cat-1',
    name: 'Manteau Trench Double Burberry',
    name_fr: 'Manteau Trench Double Burberry',
    name_en: 'Manteau Trench Double Burberry',
    slug: 'manteau-trench-double-burberry-winter-clothing',
    price: 100,
    description: 'Ein elegantes Produkt. Hochwertige Materialien und zeitloser Stil.',
    description_fr: 'Un produit élégant. Matériaux de qualité supérieure et style intemporel.',
    description_en: 'An elegant product. High-quality materials and timeless style.',
  ...
  {
    id: 'manteau-trench-double-burberry-cat-1-cat-2',
    name: 'Manteau Trench Double Burberry',
    name_fr: 'Manteau Trench Double Burberry',
    name_en: 'Manteau Trench Double Burberry',
    slug: 'manteau-trench-double-burberry-winter-clothing-mens-clothing',
    price: 100,
    description: 'Ein elegantes Produkt. Hochwertige Materialien und zeitloser Stil.',
    description_fr: 'Un produit élégant. Matériaux de qualité supérieure et style intemporel.',
    description_en: 'An elegant product. High-quality materials and timeless style.',
  ...
  },
  {
    ...
    name: 'Luxus Chronograph Luxus-Uhr',
    name_fr: 'Montre Luxe Luxus Chronograph',
    name_en: 'Luxus Chronograph Luxury Watch',
    slug: 'montre-acier-inoxydable-noire-chrono-luxe',
    price: 5853,
    description: 'Eine hochwertige Luxus-Uhr von Luxus. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Luxus. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Luxus. Precision, elegance and timeless style combined.',
    category: 'accessories',
  ...
  },
  {
    ...
    name: 'Weite Wollhose Max Mara',
    name_fr: 'Pantalon Large en Laine Max Mara',
    name_en: 'Wide Wool Trousers Max Mara',
    slug: 'pantalon-large-en-laine-max-mara',
    price: 380,
    description: 'Eine elegante weite Hose aus Wolle von Max Mara.',
    description_fr: 'Un pantalon large élégant en laine de Max Mara.',
    description_en: 'An elegant wide wool trouser by Max Mara.',
    category: 'mens-clothing',
    // subcategory: 'mens-clothing',
  ...
  {
    id: 'pantalon-large-en-laine-max-mara-cat-1',
    name: 'Weite Wollhose Max Mara',
    name_fr: 'Pantalon Large en Laine Max Mara',
    name_en: 'Wide Wool Trousers Max Mara',
    slug: 'pantalon-large-en-laine-max-mara-winter-clothing',
    price: 380,
    description: 'Eine elegante weite Hose aus Wolle von Max Mara.',
    description_fr: 'Un pantalon large élégant en laine de Max Mara.',
    description_en: 'An elegant wide wool trouser by Max Mara.',
  ...
  {
    id: 'pantalon-large-en-laine-max-mara-cat-1-cat-2',
    name: 'Weite Wollhose Max Mara',
    name_fr: 'Pantalon Large en Laine Max Mara',
    name_en: 'Wide Wool Trousers Max Mara',
    slug: 'pantalon-large-en-laine-max-mara-winter-clothing-mens-clothing',
    price: 380,
    description: 'Eine elegante weite Hose aus Wolle von Max Mara.',
    description_fr: 'Un pantalon large élégant en laine de Max Mara.',
    description_en: 'An elegant wide wool trouser by Max Mara.',
  ...
  },
  {
    ...
    name: 'Bateau-Ausschnitt-Pullover Ralph Lauren',
    name_fr: 'Pull Col Bateau Ralph Lauren',
    name_en: 'Boatneck Sweater Ralph Lauren',
    slug: 'pull-col-bateau-ralph-lauren',
    price: 180,
    description: 'Ein eleganter Pullover mit Bateau-Ausschnitt von Ralph Lauren.',
    description_fr: 'Un pull élégant à col bateau de Ralph Lauren.',
    description_en: 'An elegant boatneck sweater by Ralph Lauren.',
    category: 'mens-clothing',
    // subcategory: 'mens-clothing',
  ...
  {
    id: 'pull-col-bateau-ralph-lauren-cat-1',
    name: 'Bateau-Ausschnitt-Pullover Ralph Lauren',
    name_fr: 'Pull Col Bateau Ralph Lauren',
    name_en: 'Boatneck Sweater Ralph Lauren',
    slug: 'pull-col-bateau-ralph-lauren-winter-clothing',
    price: 180,
    description: 'Ein eleganter Pullover mit Bateau-Ausschnitt von Ralph Lauren.',
    description_fr: 'Un pull élégant à col bateau de Ralph Lauren.',
    description_en: 'An elegant boatneck sweater by Ralph Lauren.',
  ...
  {
    id: 'pull-col-bateau-ralph-lauren-cat-1-cat-2',
    name: 'Bateau-Ausschnitt-Pullover Ralph Lauren',
    name_fr: 'Pull Col Bateau Ralph Lauren',
    name_en: 'Boatneck Sweater Ralph Lauren',
    slug: 'pull-col-bateau-ralph-lauren-winter-clothing-mens-clothing',
    price: 180,
    description: 'Ein eleganter Pullover mit Bateau-Ausschnitt von Ralph Lauren.',
    description_fr: 'Un pull élégant à col bateau de Ralph Lauren.',
    description_en: 'An elegant boatneck sweater by Ralph Lauren.',
  ...
  },
  {
    ...
    name: 'Oversize-Twist-Pullover Chloé',
    name_fr: 'Pull Oversize Torsadé Chloé',
    name_en: 'Oversize Twisted Sweater Chloé',
    slug: 'pull-oversize-torsade-chloe',
    price: 420,
    description: 'Ein trendiger Oversize-Pullover mit Twist-Detail von Chloé.',
    description_fr: 'Un pull oversize tendance avec détail torsadé de Chloé.',
    description_en: 'A trendy oversize sweater with twisted detail by Chloé.',
    category: 'mens-clothing',
    // subcategory: 'mens-clothing',
  ...
  {
    id: 'pull-oversize-torsade-chloe-cat-1',
    name: 'Oversize-Twist-Pullover Chloé',
    name_fr: 'Pull Oversize Torsadé Chloé',
    name_en: 'Oversize Twisted Sweater Chloé',
    slug: 'pull-oversize-torsade-chloe-winter-clothing',
    price: 420,
    description: 'Ein trendiger Oversize-Pullover mit Twist-Detail von Chloé.',
    description_fr: 'Un pull oversize tendance avec détail torsadé de Chloé.',
    description_en: 'A trendy oversize sweater with twisted detail by Chloé.',
  ...
  {
    id: 'pull-oversize-torsade-chloe-cat-1-cat-2',
    name: 'Oversize-Twist-Pullover Chloé',
    name_fr: 'Pull Oversize Torsadé Chloé',
    name_en: 'Oversize Twisted Sweater Chloé',
    slug: 'pull-oversize-torsade-chloe-winter-clothing-mens-clothing',
    price: 420,
    description: 'Ein trendiger Oversize-Pullover mit Twist-Detail von Chloé.',
    description_fr: 'Un pull oversize tendance avec détail torsadé de Chloé.',
    description_en: 'A trendy oversize sweater with twisted detail by Chloé.',
  ...
  },
  {
    ...
    name_fr: 'Pull Élégant',
    name_en: 'Elegant Sweater',
    slug: 'pull-torsade-paul-smith',
    price: 150,
    description: 'Ein eleganter Pullover aus hochwertigen Materialien.',
    description_fr: 'Un pull élégant en matériaux de qualité supérieure.',
    description_en: 'An elegant sweater made of high-quality materials.',
    category: 'mens-clothing',
    // subcategory: 'mens-clothing',
  ...
  {
    id: 'pull-torsade-paul-smith-cat-1',
    name: 'Eleganter Pullover',
    name_fr: 'Pull Élégant',
    name_en: 'Elegant Sweater',
    slug: 'pull-torsade-paul-smith-winter-clothing',
    price: 150,
    description: 'Ein eleganter Pullover aus hochwertigen Materialien.',
    description_fr: 'Un pull élégant en matériaux de qualité supérieure.',
    description_en: 'An elegant sweater made of high-quality materials.',
  ...
  {
    id: 'pull-torsade-paul-smith-cat-1-cat-2',
    name: 'Eleganter Pullover',
    name_fr: 'Pull Élégant',
    name_en: 'Elegant Sweater',
    slug: 'pull-torsade-paul-smith-winter-clothing-mens-clothing',
    price: 150,
    description: 'Ein eleganter Pullover aus hochwertigen Materialien.',
    description_fr: 'Un pull élégant en matériaux de qualité supérieure.',
    description_en: 'An elegant sweater made of high-quality materials.',
  ...
  },
  {
    ...
    name: 'Asymmetrisches Kleid Givenchy',
    name_fr: 'Robe Asymétrique Givenchy',
    name_en: 'Asymmetric Dress Givenchy',
    slug: 'robe-asymetrique-givenchy',
    price: 890,
    description: 'Ein avantgardistisches asymmetrisches Kleid von Givenchy.',
    description_fr: 'Une robe asymétrique avant-gardiste de Givenchy.',
    description_en: 'An avant-garde asymmetric dress by Givenchy.',
    category: 'womens-clothing',
    // subcategory: 'womens-clothing',
  ...
  },
  {
    ...
    name: 'Kurzes Wollkleid Prada',
    name_fr: 'Robe Courte en Laine Prada',
    name_en: 'Short Wool Dress Prada',
    slug: 'robe-courte-en-laine-prada',
    price: 650,
    description: 'Ein elegantes kurzes Kleid aus Wolle von Prada.',
    description_fr: 'Une robe courte élégante en laine de Prada.',
    description_en: 'An elegant short wool dress by Prada.',
    category: 'womens-clothing',
    // subcategory: 'womens-clothing',
  ...
  {
    id: 'robe-courte-en-laine-prada-cat-1',
    name: 'Kurzes Wollkleid Prada',
    name_fr: 'Robe Courte en Laine Prada',
    name_en: 'Short Wool Dress Prada',
    slug: 'robe-courte-en-laine-prada-winter-clothing',
    price: 650,
    description: 'Ein elegantes kurzes Kleid aus Wolle von Prada.',
    description_fr: 'Une robe courte élégante en laine de Prada.',
    description_en: 'An elegant short wool dress by Prada.',
  ...
  {
    id: 'robe-courte-en-laine-prada-cat-1-cat-2',
    name: 'Kurzes Wollkleid Prada',
    name_fr: 'Robe Courte en Laine Prada',
    name_en: 'Short Wool Dress Prada',
    slug: 'robe-courte-en-laine-prada-winter-clothing-womens-clothing',
    price: 650,
    description: 'Ein elegantes kurzes Kleid aus Wolle von Prada.',
    description_fr: 'Une robe courte élégante en laine de Prada.',
    description_en: 'An elegant short wool dress by Prada.',
  ...
  },
  {
    ...
    name: 'Langes Plisseekleid Valentino',
    name_fr: 'Robe Longue Plissée Valentino',
    name_en: 'Long Pleated Dress Valentino',
    slug: 'robe-longue-plissee-valentino',
    price: 1250,
    description: 'Ein luxuriöses langes Plisseekleid von Valentino.',
    description_fr: 'Une robe longue plissée luxueuse de Valentino.',
    description_en: 'A luxurious long pleated dress by Valentino.',
    category: 'womens-clothing',
    // subcategory: 'womens-clothing',
  ...
  },
  {
    ...
    name: 'Seidenkleid im Portefeuille-Stil Diane von Furstenberg',
    name_fr: 'Robe Portefeuille en Soie Diane von Furstenberg',
    name_en: 'Silk Wrap Dress Diane von Furstenberg',
    slug: 'robe-portefeuille-en-soie-diane-von-furstenberg',
    price: 420,
    description: 'Ein ikonisches Seidenkleid im Portefeuille-Stil von Diane von Furstenberg.',
    description_fr: 'Une robe portefeuille iconique en soie de Diane von Furstenberg.',
    description_en: 'An iconic silk wrap dress by Diane von Furstenberg.',
    category: 'womens-clothing',
    // subcategory: 'womens-clothing',
  ...
  {
    id: 'robe-portefeuille-en-soie-diane-von-furstenberg-cat-1',
    name: 'Seidenkleid im Portefeuille-Stil Diane von Furstenberg',
    name_fr: 'Robe Portefeuille en Soie Diane von Furstenberg',
    name_en: 'Silk Wrap Dress Diane von Furstenberg',
    slug: 'robe-portefeuille-en-soie-diane-von-furstenberg-accessories',
    price: 420,
    description: 'Ein ikonisches Seidenkleid im Portefeuille-Stil von Diane von Furstenberg.',
    description_fr: 'Une robe portefeuille iconique en soie de Diane von Furstenberg.',
    description_en: 'An iconic silk wrap dress by Diane von Furstenberg.',
  ...
  {
    id: 'robe-portefeuille-en-soie-diane-von-furstenberg-cat-1-cat-2',
    name: 'Seidenkleid im Portefeuille-Stil Diane von Furstenberg',
    name_fr: 'Robe Portefeuille en Soie Diane von Furstenberg',
    name_en: 'Silk Wrap Dress Diane von Furstenberg',
    slug: 'robe-portefeuille-en-soie-diane-von-furstenberg-accessories-womens-clothing',
    price: 420,
    description: 'Ein ikonisches Seidenkleid im Portefeuille-Stil von Diane von Furstenberg.',
    description_fr: 'Une robe portefeuille iconique en soie de Diane von Furstenberg.',
    description_en: 'An iconic silk wrap dress by Diane von Furstenberg.',
  ...
  },
  {
    ...
    name: 'Luxus-Ledersneaker Nubuck Runway',
    name_fr: 'Sneakers Luxe Cuir Nubuck Runway',
    name_en: 'Luxury Leather Sneakers Nubuck Runway',
    slug: 'sneakers-luxe-cuir-nubuck-runway',
    price: 450,
    description: 'Hochwertige Ledersneaker aus Nubuck-Leder.',
    description_fr: 'Des sneakers en cuir de qualité supérieure en nubuck.',
    description_en: 'High-quality leather sneakers in nubuck leather.',
    category: 'shoes',
  ...
  },
  {
    ...
    name: 'Survetement Luxe Adidas Gucci',
  ...
  },
  {
    ...
    name: 'Kapuzen-Sweatshirt Off-White',
    name_fr: 'Sweat à Capuche Off-White',
    name_en: 'Hooded Sweatshirt Off-White',
    slug: 'sweat-a-capuche-off-white',
    price: 380,
    description: 'Ein trendiges Kapuzen-Sweatshirt von Off-White.',
    description_fr: 'Un sweat à capuche tendance de Off-White.',
    description_en: 'A trendy hooded sweatshirt by Off-White.',
    category: 'sport',
  ...
  },
  {
    ...
    name: 'T-Shirt mit Logo Givenchy',
    name_fr: 'T-shirt Logo Givenchy',
    name_en: 'Logo T-shirt Givenchy',
    slug: 't-shirt-logo-givenchy',
    price: 280,
    description: 'Ein trendiges T-Shirt mit Logo von Givenchy.',
    description_fr: 'Un t-shirt tendance avec logo de Givenchy.',
    description_en: 'A trendy logo t-shirt by Givenchy.',
    category: 'mens-clothing',
    // subcategory: 'mens-clothing',
  ...
  },
  {
    ...
    name: 'Kurze Steppjacke Moncler',
    name_fr: 'Veste Courte Matelassée Moncler',
    name_en: 'Short Quilted Jacket Moncler',
    slug: 'veste-courte-matelassee-moncler',
    price: 850,
    description: 'Eine warme kurze Steppjacke von Moncler.',
    description_fr: 'Une veste courte matelassée chaude de Moncler.',
    description_en: 'A warm short quilted jacket by Moncler.',
    category: 'mens-clothing',
    // subcategory: 'mens-clothing',
  ...
  },
  {
    ...
    name: 'Denimjacke Levis Made & Crafted',
    name_fr: 'Veste Denim Levis Made & Crafted',
    name_en: 'Denim Jacket Levis Made & Crafted',
    slug: 'veste-denim-levis-made-crafted',
    price: 180,
    description: 'Eine hochwertige Denimjacke von Levis Made & Crafted.',
    description_fr: 'Une veste denim de qualité supérieure de Levis Made & Crafted.',
    description_en: 'A high-quality denim jacket by Levis Made & Crafted.',
    category: 'mens-clothing',
    // subcategory: 'mens-clothing',
  ...
  },
  {
    ...
    name: 'Steppjacke Barbour International',
    name_fr: 'Veste Matelassée Barbour International',
    name_en: 'Quilted Jacket Barbour International',
    slug: 'veste-matelassee-barbour-international',
    price: 320,
    description: 'Eine funktionale Steppjacke von Barbour International.',
    description_fr: 'Une veste matelassée fonctionnelle de Barbour International.',
    description_en: 'A functional quilted jacket by Barbour International.',
    category: 'mens-clothing',
    // subcategory: 'mens-clothing',
  ...
  },
  {
    ...
    name: 'Technische Regenjacke The North Face',
    name_fr: 'Veste Technique Imperméable The North Face',
    name_en: 'Waterproof Technical Jacket The North Face',
    slug: 'veste-technique-impermeable-tnf-black-series',
    price: 280,
    description: 'Eine wasserdichte technische Jacke von The North Face.',
    description_fr: 'Une veste technique imperméable de The North Face.',
    description_en: 'A waterproof technical jacket by The North Face.',
    category: 'mens-clothing',
    // subcategory: 'mens-clothing',
  ...
  },
  {
    ...
    name: 'Technische Jacke Nike ACG',
    name_fr: 'Veste Technique Nike ACG',
    name_en: 'Technical Jacket Nike ACG',
    slug: 'veste-technique-nike-acg',
    price: 220,
    description: 'Eine hochfunktionale technische Jacke von Nike ACG.',
    description_fr: 'Une veste technique hautement fonctionnelle de Nike ACG.',
    description_en: 'A highly functional technical jacket by Nike ACG.',
    category: 'mens-clothing',
    // subcategory: 'mens-clothing',
  ...
  {
    id: 'veste-technique-nike-acg-cat-1',
    name: 'Technische Jacke Nike ACG',
    name_fr: 'Veste Technique Nike ACG',
    name_en: 'Technical Jacket Nike ACG',
    slug: 'veste-technique-nike-acg-sport',
    price: 220,
    description: 'Eine hochfunktionale technische Jacke von Nike ACG.',
    description_fr: 'Une veste technique hautement fonctionnelle de Nike ACG.',
    description_en: 'A highly functional technical jacket by Nike ACG.',
  ...
  {
    id: 'veste-technique-nike-acg-cat-1-cat-2',
    name: 'Technische Jacke Nike ACG',
    name_fr: 'Veste Technique Nike ACG',
    name_en: 'Technical Jacket Nike ACG',
    slug: 'veste-technique-nike-acg-sport-mens-clothing',
    price: 220,
    description: 'Eine hochfunktionale technische Jacke von Nike ACG.',
    description_fr: 'Une veste technique hautement fonctionnelle de Nike ACG.',
    description_en: 'A highly functional technical jacket by Nike ACG.',
  ...
  {
    id: 'tui--rouge--lvres',
    name: 'Lippenstift-Etui',
    name_fr: 'Étui à Rouge à Lèvres',
    name_en: 'Lipstick Case',
    slug: 'tui--rouge--lvres',
    price: 55,
    description: 'Ein elegantes Lippenstift-Etui aus hochwertigem Material.',
    description_fr: 'Un étui à rouge à lèvres élégant en matériau de qualité supérieure.',
    description_en: 'An elegant lipstick case made of high-quality material.',
    category: 'accessories',
    images: ['Étui_à_rouge_à_lèvres'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Rosa', name_fr: 'Rose', name_en: 'Pink' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  },
  {
    id: 'omega-seamaster-aqua-terra-2503-50-coffret-complet-2010-bo-te-papiers',
    name: 'Omega Seamaster Aqua Terra Luxus-Uhr',
    name_fr: 'Montre Luxe Omega Seamaster Aqua Terra',
    name_en: 'Omega Seamaster Aqua Terra Luxury Watch',
    slug: 'omega-seamaster-aqua-terra-2503-50-coffret-complet-2010-bo-te-papiers',
    price: 7128,
    description: 'Eine hochwertige Luxus-Uhr von Omega. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Omega. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Omega. Precision, elegance and timeless style combined.',
    category: 'accessories',
  ...
  },
  {
    ...
    name: 'Tudor Black Bay Luxus-Uhr',
    name_fr: 'Montre Luxe Tudor Black Bay',
    name_en: 'Tudor Black Bay Luxury Watch',
    slug: 'tudor-black-bay-harrods-coffret-complet-2018-r-f-79230g',
    price: 6274,
    description: 'Eine hochwertige Luxus-Uhr von Tudor. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Tudor. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Tudor. Precision, elegance and timeless style combined.',
    category: 'accessories',
  ...
  },
  {
    ...
    name: 'IWC Pilot Luxus-Uhr',
    name_fr: 'Montre Luxe IWC Pilot',
    name_en: 'IWC Pilot Luxury Watch',
    slug: 'montre-iwc-big-pilot-le-petit-prince-iw502703-calendrier-annuel-dition-limit-e',
    price: 7004,
    description: 'Eine hochwertige Luxus-Uhr von IWC. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de IWC. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by IWC. Precision, elegance and timeless style combined.',
    category: 'accessories',
  ...
  {
    id: 'tudor-mod-le-20300-chronographe-sport-bo-te-et-papiers-cat-1',
    name: 'Tudor Black Bay Luxus-Uhr',
    name_fr: 'Montre Luxe Tudor Black Bay',
    name_en: 'Tudor Black Bay Luxury Watch',
    slug: 'tudor-mod-le-20300-chronographe-sport-bo-te-et-papiers-sport',
    price: 6722,
    description: 'Eine hochwertige Luxus-Uhr von Tudor. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Tudor. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Tudor. Precision, elegance and timeless style combined.',
  ...
  {
    id: 'tudor-mod-le-20300-chronographe-sport-bo-te-et-papiers-cat-1-cat-2',
    name: 'Tudor Black Bay Luxus-Uhr',
    name_fr: 'Montre Luxe Tudor Black Bay',
    name_en: 'Tudor Black Bay Luxury Watch',
    slug: 'tudor-mod-le-20300-chronographe-sport-bo-te-et-papiers-sport-accessories',
    price: 6722,
    description: 'Eine hochwertige Luxus-Uhr von Tudor. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Tudor. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Tudor. Precision, elegance and timeless style combined.',
  ...
  {
    id: 'montre-chronographe-iwc-pilot-top-gun-lake-tahoe-iw389105-en-c-ramique-blanche-45-mm-neuf-cat-1',
    name: 'IWC Pilot Luxus-Uhr',
    name_fr: 'Montre Luxe IWC Pilot',
    name_en: 'IWC Pilot Luxury Watch',
    slug: 'montre-chronographe-iwc-pilot-top-gun-lake-tahoe-iw389105-en-c-ramique-blanche-45-mm-neuf-accessories',
    price: 3129,
    description: 'Eine hochwertige Luxus-Uhr von IWC. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de IWC. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by IWC. Precision, elegance and timeless style combined.',
  ...
  {
    id: 'montre-chronographe-iwc-pilot-top-gun-lake-tahoe-iw389105-en-c-ramique-blanche-45-mm-neuf-cat-1-cat-2',
    name: 'IWC Pilot Luxus-Uhr',
    name_fr: 'Montre Luxe IWC Pilot',
    name_en: 'IWC Pilot Luxury Watch',
    slug: 'montre-chronographe-iwc-pilot-top-gun-lake-tahoe-iw389105-en-c-ramique-blanche-45-mm-neuf-accessories-womens-clothing',
    price: 3129,
    description: 'Eine hochwertige Luxus-Uhr von IWC. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de IWC. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by IWC. Precision, elegance and timeless style combined.',
  ...
  },
  {
    ...
    name: 'Cartier Santos Luxus-Uhr',
    name_fr: 'Montre Luxe Cartier Santos',
    name_en: 'Cartier Santos Luxury Watch',
    slug: 'montre-cartier-santos-2025-grand-cadran-vert-wssa0062-bracelet-acier-cuir-coffret-complet',
    price: 6456,
    description: 'Eine hochwertige Luxus-Uhr von Cartier. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Cartier. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Cartier. Precision, elegance and timeless style combined.',
    category: 'accessories',
  ...
  },
  {
    ...
    name: 'Jaeger-LeCoultre Reverso Luxus-Uhr',
    name_fr: 'Montre Luxe Jaeger-LeCoultre Reverso',
    name_en: 'Jaeger-LeCoultre Reverso Luxury Watch',
    slug: 'jaeger-lecoultre-2024-reverso-214-8-62-q3858522-acier-inoxydable',
    price: 7203,
    description: 'Eine hochwertige Luxus-Uhr von Jaeger-LeCoultre. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Jaeger-LeCoultre. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Jaeger-LeCoultre. Precision, elegance and timeless style combined.',
    category: 'accessories',
  ...
  },
  {
    ...
    name: 'Omega Speedmaster Luxus-Uhr',
    name_fr: 'Montre Luxe Omega Speedmaster',
    name_en: 'Omega Speedmaster Luxury Watch',
  ...
  {
    id: 'omega-seamaster-aqua-terra-2503-50-coffret-complet-2010-bo-te-papiers-2',
    name: 'Omega Seamaster Aqua Terra Luxus-Uhr',
    name_fr: 'Montre Luxe Omega Seamaster Aqua Terra',
    name_en: 'Omega Seamaster Aqua Terra Luxury Watch',
    slug: 'omega-seamaster-aqua-terra-2503-50-coffret-complet-2010-bo-te-papiers-2',
    price: 6576,
    description: 'Eine hochwertige Luxus-Uhr von Omega. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Omega. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Omega. Precision, elegance and timeless style combined.',
    category: 'accessories',
    images: ['omega_seamaster_aqua_terra_2503_50_coffret_complet_2010_bo_te_papiers_2'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Silber', name_fr: 'Argent', name_en: 'Silver' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  },
  {
    id: 'omega-seamaster-aqua-terra-2503-50-coffret-complet-2010-bo-te-papiers-3',
    name: 'Omega Seamaster Aqua Terra Luxus-Uhr',
    name_fr: 'Montre Luxe Omega Seamaster Aqua Terra',
    name_en: 'Omega Seamaster Aqua Terra Luxury Watch',
    slug: 'omega-seamaster-aqua-terra-2503-50-coffret-complet-2010-bo-te-papiers-3',
    price: 6672,
    description: 'Eine hochwertige Luxus-Uhr von Omega. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Omega. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Omega. Precision, elegance and timeless style combined.',
    category: 'accessories',
    images: ['omega_seamaster_aqua_terra_2503_50_coffret_complet_2010_bo_te_papiers_3'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Silber', name_fr: 'Argent', name_en: 'Silver' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  },
  {
    id: 'tudor-black-bay-harrods-coffret-complet-2018-r-f-79230g-2',
    name: 'Tudor Black Bay Luxus-Uhr',
    name_fr: 'Montre Luxe Tudor Black Bay',
    name_en: 'Tudor Black Bay Luxury Watch',
    slug: 'tudor-black-bay-harrods-coffret-complet-2018-r-f-79230g-2',
    price: 3222,
    description: 'Eine hochwertige Luxus-Uhr von Tudor. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Tudor. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Tudor. Precision, elegance and timeless style combined.',
    category: 'accessories',
    images: ['tudor_black_bay_harrods_coffret_complet_2018_r_f_79230g_2'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Silber', name_fr: 'Argent', name_en: 'Silver' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  },
  {
    id: 'tudor-black-bay-harrods-coffret-complet-2018-r-f-79230g-3',
    name: 'Tudor Black Bay Luxus-Uhr',
    name_fr: 'Montre Luxe Tudor Black Bay',
    name_en: 'Tudor Black Bay Luxury Watch',
    slug: 'tudor-black-bay-harrods-coffret-complet-2018-r-f-79230g-3',
    price: 3770,
    description: 'Eine hochwertige Luxus-Uhr von Tudor. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Tudor. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Tudor. Precision, elegance and timeless style combined.',
    category: 'accessories',
    images: ['tudor_black_bay_harrods_coffret_complet_2018_r_f_79230g_3'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Silber', name_fr: 'Argent', name_en: 'Silver' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  },
  {
  ...
  {
    id: 'omega-speedmaster-dark-side-of-the-moon-dsotm-311-92-44-51-01-006-avec-cartes-2',
    name: 'Omega Speedmaster Luxus-Uhr',
    name_fr: 'Montre Luxe Omega Speedmaster',
    name_en: 'Omega Speedmaster Luxury Watch',
    slug: 'omega-speedmaster-dark-side-of-the-moon-dsotm-311-92-44-51-01-006-avec-cartes-2',
    price: 6473,
    description: 'Eine hochwertige Luxus-Uhr von Omega. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Omega. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Omega. Precision, elegance and timeless style combined.',
    category: 'accessories',
    images: ['omega_speedmaster_dark_side_of_the_moon_dsotm_311_92_44_51_01_006_avec_cartes_2'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Silber', name_fr: 'Argent', name_en: 'Silver' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  },
  {
    id: 'omega-speedmaster-dark-side-of-the-moon-dsotm-311-92-44-51-01-006-avec-cartes-3',
    name: 'Omega Speedmaster Luxus-Uhr',
    name_fr: 'Montre Luxe Omega Speedmaster',
    name_en: 'Omega Speedmaster Luxury Watch',
    slug: 'omega-speedmaster-dark-side-of-the-moon-dsotm-311-92-44-51-01-006-avec-cartes-3',
    price: 4948,
    description: 'Eine hochwertige Luxus-Uhr von Omega. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Omega. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Omega. Precision, elegance and timeless style combined.',
    category: 'accessories',
    images: ['omega_speedmaster_dark_side_of_the_moon_dsotm_311_92_44_51_01_006_avec_cartes_3'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Silber', name_fr: 'Argent', name_en: 'Silver' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  },
  {
  ...
  {
    id: 'omega-speedmaster-apollo-8-dark-side-of-the-moon-311-92-44-30-c-ramique-kit-complet-2',
    name: 'Omega Speedmaster Luxus-Uhr',
    name_fr: 'Montre Luxe Omega Speedmaster',
    name_en: 'Omega Speedmaster Luxury Watch',
    slug: 'omega-speedmaster-apollo-8-dark-side-of-the-moon-311-92-44-30-c-ramique-kit-complet-2',
    price: 6164,
    description: 'Eine hochwertige Luxus-Uhr von Omega. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Omega. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Omega. Precision, elegance and timeless style combined.',
    category: 'accessories',
    images: ['omega_speedmaster_apollo_8_dark_side_of_the_moon_311_92_44_30_c_ramique_kit_complet_2'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Silber', name_fr: 'Argent', name_en: 'Silver' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  },
  {
    id: 'omega-speedmaster-apollo-8-dark-side-of-the-moon-311-92-44-30-c-ramique-kit-complet-3',
    name: 'Omega Speedmaster Luxus-Uhr',
    name_fr: 'Montre Luxe Omega Speedmaster',
    name_en: 'Omega Speedmaster Luxury Watch',
    slug: 'omega-speedmaster-apollo-8-dark-side-of-the-moon-311-92-44-30-c-ramique-kit-complet-3',
    price: 6630,
    description: 'Eine hochwertige Luxus-Uhr von Omega. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Omega. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Omega. Precision, elegance and timeless style combined.',
    category: 'accessories',
    images: ['omega_speedmaster_apollo_8_dark_side_of_the_moon_311_92_44_30_c_ramique_kit_complet_3'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Silber', name_fr: 'Argent', name_en: 'Silver' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  },
  {
  ...
  {
    id: 'montre-cartier-santos-cadran-vert-grande-taille-wssa0062-2',
    name: 'Cartier Santos Luxus-Uhr',
    name_fr: 'Montre Luxe Cartier Santos',
    name_en: 'Cartier Santos Luxury Watch',
    slug: 'montre-cartier-santos-cadran-vert-grande-taille-wssa0062-2',
    price: 3159,
    description: 'Eine hochwertige Luxus-Uhr von Cartier. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Cartier. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Cartier. Precision, elegance and timeless style combined.',
    category: 'accessories',
    images: ['montre_cartier_santos_cadran_vert_grande_taille_wssa0062_2'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Silber', name_fr: 'Argent', name_en: 'Silver' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  },
  {
    id: 'montre-cartier-santos-cadran-vert-grande-taille-wssa0062-3',
    name: 'Cartier Santos Luxus-Uhr',
    name_fr: 'Montre Luxe Cartier Santos',
    name_en: 'Cartier Santos Luxury Watch',
    slug: 'montre-cartier-santos-cadran-vert-grande-taille-wssa0062-3',
    price: 3019,
    description: 'Eine hochwertige Luxus-Uhr von Cartier. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Cartier. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Cartier. Precision, elegance and timeless style combined.',
    category: 'accessories',
    images: ['montre_cartier_santos_cadran_vert_grande_taille_wssa0062_3'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Silber', name_fr: 'Argent', name_en: 'Silver' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  },
  {
    id: 'montre-chronographe-iwc-pilot-top-gun-lake-tahoe-iw389105-en-c-ramique-blanche-45-mm-neuf-2',
    name: 'IWC Pilot Luxus-Uhr',
    name_fr: 'Montre Luxe IWC Pilot',
    name_en: 'IWC Pilot Luxury Watch',
    slug: 'montre-chronographe-iwc-pilot-top-gun-lake-tahoe-iw389105-en-c-ramique-blanche-45-mm-neuf-2',
    price: 2678,
    description: 'Eine hochwertige Luxus-Uhr von IWC. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de IWC. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by IWC. Precision, elegance and timeless style combined.',
    category: 'womens-clothing',
    images: ['montre_chronographe_iwc_pilot_top_gun_lake_tahoe_iw389105_en_c_ramique_blanche_45_mm_neuf_2'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Silber', name_fr: 'Argent', name_en: 'Silver' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  },
  {
    id: 'montre-chronographe-iwc-pilot-top-gun-lake-tahoe-iw389105-en-c-ramique-blanche-45-mm-neuf-2-cat-1',
    name: 'IWC Pilot Luxus-Uhr',
    name_fr: 'Montre Luxe IWC Pilot',
    name_en: 'IWC Pilot Luxury Watch',
    slug: 'montre-chronographe-iwc-pilot-top-gun-lake-tahoe-iw389105-en-c-ramique-blanche-45-mm-neuf-2-accessories',
    price: 2678,
    description: 'Eine hochwertige Luxus-Uhr von IWC. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de IWC. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by IWC. Precision, elegance and timeless style combined.',
  ...
  {
    id: 'montre-chronographe-iwc-pilot-top-gun-lake-tahoe-iw389105-en-c-ramique-blanche-45-mm-neuf-2-cat-1-cat-2',
    name: 'IWC Pilot Luxus-Uhr',
    name_fr: 'Montre Luxe IWC Pilot',
    name_en: 'IWC Pilot Luxury Watch',
    slug: 'montre-chronographe-iwc-pilot-top-gun-lake-tahoe-iw389105-en-c-ramique-blanche-45-mm-neuf-2-accessories-womens-clothing',
    price: 2678,
    description: 'Eine hochwertige Luxus-Uhr von IWC. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de IWC. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by IWC. Precision, elegance and timeless style combined.',
  ...
  {
    id: 'montre-chronographe-iwc-pilot-top-gun-lake-tahoe-iw389105-en-c-ramique-blanche-45-mm-neuf-3',
    name: 'IWC Pilot Luxus-Uhr',
    name_fr: 'Montre Luxe IWC Pilot',
    name_en: 'IWC Pilot Luxury Watch',
    slug: 'montre-chronographe-iwc-pilot-top-gun-lake-tahoe-iw389105-en-c-ramique-blanche-45-mm-neuf-3',
    price: 5280,
    description: 'Eine hochwertige Luxus-Uhr von IWC. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de IWC. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by IWC. Precision, elegance and timeless style combined.',
    category: 'womens-clothing',
    images: ['montre_chronographe_iwc_pilot_top_gun_lake_tahoe_iw389105_en_c_ramique_blanche_45_mm_neuf_3'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Silber', name_fr: 'Argent', name_en: 'Silver' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  },
  {
    id: 'montre-chronographe-iwc-pilot-top-gun-lake-tahoe-iw389105-en-c-ramique-blanche-45-mm-neuf-3-cat-1',
    name: 'IWC Pilot Luxus-Uhr',
    name_fr: 'Montre Luxe IWC Pilot',
    name_en: 'IWC Pilot Luxury Watch',
    slug: 'montre-chronographe-iwc-pilot-top-gun-lake-tahoe-iw389105-en-c-ramique-blanche-45-mm-neuf-3-accessories',
    price: 5280,
    description: 'Eine hochwertige Luxus-Uhr von IWC. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de IWC. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by IWC. Precision, elegance and timeless style combined.',
  ...
  {
    id: 'montre-chronographe-iwc-pilot-top-gun-lake-tahoe-iw389105-en-c-ramique-blanche-45-mm-neuf-3-cat-1-cat-2',
    name: 'IWC Pilot Luxus-Uhr',
    name_fr: 'Montre Luxe IWC Pilot',
    name_en: 'IWC Pilot Luxury Watch',
    slug: 'montre-chronographe-iwc-pilot-top-gun-lake-tahoe-iw389105-en-c-ramique-blanche-45-mm-neuf-3-accessories-womens-clothing',
    price: 5280,
    description: 'Eine hochwertige Luxus-Uhr von IWC. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de IWC. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by IWC. Precision, elegance and timeless style combined.',
  ...
  {
    id: 'chronographe-tudor-black-bay-2',
    name: 'Tudor Black Bay Luxus-Uhr',
    name_fr: 'Montre Luxe Tudor Black Bay',
    name_en: 'Tudor Black Bay Luxury Watch',
    slug: 'chronographe-tudor-black-bay-2',
    price: 6446,
    description: 'Eine hochwertige Luxus-Uhr von Tudor. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Tudor. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Tudor. Precision, elegance and timeless style combined.',
    category: 'accessories',
    images: ['chronographe_tudor_black_bay_2'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Silber', name_fr: 'Argent', name_en: 'Silver' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  },
  {
    id: 'chronographe-tudor-black-bay-3',
    name: 'Tudor Black Bay Luxus-Uhr',
    name_fr: 'Montre Luxe Tudor Black Bay',
    name_en: 'Tudor Black Bay Luxury Watch',
    slug: 'chronographe-tudor-black-bay-3',
    price: 7249,
    description: 'Eine hochwertige Luxus-Uhr von Tudor. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Tudor. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Tudor. Precision, elegance and timeless style combined.',
    category: 'accessories',
    images: ['chronographe_tudor_black_bay_3'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Silber', name_fr: 'Argent', name_en: 'Silver' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  },
  {
    id: 'tudor-mod-le-20300-chronographe-sport-bo-te-et-papiers-2',
    name: 'Tudor Black Bay Luxus-Uhr',
    name_fr: 'Montre Luxe Tudor Black Bay',
    name_en: 'Tudor Black Bay Luxury Watch',
    slug: 'tudor-mod-le-20300-chronographe-sport-bo-te-et-papiers-2',
    price: 3679,
    description: 'Eine hochwertige Luxus-Uhr von Tudor. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Tudor. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Tudor. Precision, elegance and timeless style combined.',
    category: 'accessories',
    images: ['tudor_mod_le_20300_chronographe_sport_bo_te_et_papiers_2'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Silber', name_fr: 'Argent', name_en: 'Silver' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  },
  {
    id: 'tudor-mod-le-20300-chronographe-sport-bo-te-et-papiers-2-cat-1',
    name: 'Tudor Black Bay Luxus-Uhr',
    name_fr: 'Montre Luxe Tudor Black Bay',
    name_en: 'Tudor Black Bay Luxury Watch',
    slug: 'tudor-mod-le-20300-chronographe-sport-bo-te-et-papiers-2-sport',
    price: 3679,
    description: 'Eine hochwertige Luxus-Uhr von Tudor. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Tudor. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Tudor. Precision, elegance and timeless style combined.',
  ...
  {
    id: 'tudor-mod-le-20300-chronographe-sport-bo-te-et-papiers-2-cat-1-cat-2',
    name: 'Tudor Black Bay Luxus-Uhr',
    name_fr: 'Montre Luxe Tudor Black Bay',
    name_en: 'Tudor Black Bay Luxury Watch',
    slug: 'tudor-mod-le-20300-chronographe-sport-bo-te-et-papiers-2-sport-accessories',
    price: 3679,
    description: 'Eine hochwertige Luxus-Uhr von Tudor. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Tudor. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Tudor. Precision, elegance and timeless style combined.',
  ...
  {
    id: 'tudor-mod-le-20300-chronographe-sport-bo-te-et-papiers-3',
    name: 'Tudor Black Bay Luxus-Uhr',
    name_fr: 'Montre Luxe Tudor Black Bay',
    name_en: 'Tudor Black Bay Luxury Watch',
    slug: 'tudor-mod-le-20300-chronographe-sport-bo-te-et-papiers-3',
    price: 4285,
    description: 'Eine hochwertige Luxus-Uhr von Tudor. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Tudor. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Tudor. Precision, elegance and timeless style combined.',
    category: 'accessories',
    images: ['tudor_mod_le_20300_chronographe_sport_bo_te_et_papiers_3'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Silber', name_fr: 'Argent', name_en: 'Silver' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  },
  {
    id: 'tudor-mod-le-20300-chronographe-sport-bo-te-et-papiers-3-cat-1',
    name: 'Tudor Black Bay Luxus-Uhr',
    name_fr: 'Montre Luxe Tudor Black Bay',
    name_en: 'Tudor Black Bay Luxury Watch',
    slug: 'tudor-mod-le-20300-chronographe-sport-bo-te-et-papiers-3-sport',
    price: 4285,
    description: 'Eine hochwertige Luxus-Uhr von Tudor. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Tudor. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Tudor. Precision, elegance and timeless style combined.',
  ...
  {
    id: 'tudor-mod-le-20300-chronographe-sport-bo-te-et-papiers-3-cat-1-cat-2',
    name: 'Tudor Black Bay Luxus-Uhr',
    name_fr: 'Montre Luxe Tudor Black Bay',
    name_en: 'Tudor Black Bay Luxury Watch',
    slug: 'tudor-mod-le-20300-chronographe-sport-bo-te-et-papiers-3-sport-accessories',
    price: 4285,
    description: 'Eine hochwertige Luxus-Uhr von Tudor. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Tudor. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Tudor. Precision, elegance and timeless style combined.',
  ...
  {
    id: 'tudor-heritage-70330b-2',
    name: 'Tudor Black Bay Luxus-Uhr',
    name_fr: 'Montre Luxe Tudor Black Bay',
    name_en: 'Tudor Black Bay Luxury Watch',
    slug: 'tudor-heritage-70330b-2',
    price: 3463,
    description: 'Eine hochwertige Luxus-Uhr von Tudor. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Tudor. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Tudor. Precision, elegance and timeless style combined.',
    category: 'accessories',
    images: ['tudor_heritage_70330b_2'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Silber', name_fr: 'Argent', name_en: 'Silver' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  },
  {
    id: 'tudor-heritage-70330b-3',
    name: 'Tudor Black Bay Luxus-Uhr',
    name_fr: 'Montre Luxe Tudor Black Bay',
    name_en: 'Tudor Black Bay Luxury Watch',
    slug: 'tudor-heritage-70330b-3',
    price: 6530,
    description: 'Eine hochwertige Luxus-Uhr von Tudor. Präzision, Eleganz und zeitloser Stil vereint.',
    description_fr: 'Une montre de luxe de qualité supérieure de Tudor. Précision, élégance et style intemporel réunis.',
    description_en: 'A high-quality luxury watch by Tudor. Precision, elegance and timeless style combined.',
    category: 'accessories',
    images: ['tudor_heritage_70330b_3'],
    sizes: ['Unique'],
    colors: [{ name_de: 'Silber', name_fr: 'Argent', name_en: 'Silver' }, { name_de: 'Schwarz', name_fr: 'Noir', name_en: 'Black' }],
  }
];
...
export function getProductsBySubcategory(products: Product[], categorySlug: string, subcategorySlug: string, limit?: number): Product[] {
  // D'abord filtrer par catégorie
  let filteredProducts = products.filter((p) => p.category === categorySlug);
  
  // Ensuite filtrer par sous-catégorie
  filteredProducts = filteredProducts.filter((p) => p.subcategory === subcategorySlug);
